use utf8;
package Schema::Bugzilla::4_3_3::Result::bug_severity;
...
Schema::Bugzilla::4_3_3::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jVR1bJJ2e+Xk2eW2b3vtkQ
