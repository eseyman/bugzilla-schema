use utf8;
package Schema::Bugzilla::4_3_3::Result::Group;
...
Schema::Bugzilla::4_3_3::Result::Group
...
Related object: L<Schema::Bugzilla::4_3_3::Result::CategoryGroupMap>

=cut

__PACKAGE__->has_many(
  "category_group_maps",
  "Schema::Bugzilla::4_3_3::Result::CategoryGroupMap",
  { "foreign.group_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::Flagtype>

=cut

__PACKAGE__->has_many(
  "flagtypes_grant_groups",
  "Schema::Bugzilla::4_3_3::Result::Flagtype",
...
Related object: L<Schema::Bugzilla::4_3_3::Result::GroupGroupMap>

=cut

__PACKAGE__->has_many(
  "group_group_map_grantors",
  "Schema::Bugzilla::4_3_3::Result::GroupGroupMap",
...
Related object: L<Schema::Bugzilla::4_3_3::Result::NamedqueryGroupMap>

=cut

__PACKAGE__->has_many(
  "namedquery_group_maps",
  "Schema::Bugzilla::4_3_3::Result::NamedqueryGroupMap",
  { "foreign.group_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:U0X7ZA81MaK0qwFaw5vdnw
