use utf8;
package Schema::Bugzilla::4_3_3::Result::resolution;
...
Schema::Bugzilla::4_3_3::Result::resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:guGgedPdrVV6Bjl9P7oCDg
