use utf8;
package Schema::Bugzilla::4_3_3::Result::Flagtype;
...
Related object: L<Schema::Bugzilla::4_3_3::Result::Group>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xIpfkH61gWABZYeEAQ9/QQ
