use utf8;
package Schema::Bugzilla::4_3_3::Result::profiles;
...
Related object: L<Schema::Bugzilla::4_3_3::Result::audit_log>

=cut

__PACKAGE__->has_many(
  "audit_logs",
  "Schema::Bugzilla::4_3_3::Result::audit_log",
...
Related object: L<Schema::Bugzilla::4_3_3::Result::component_cc>

=cut

__PACKAGE__->has_many(
  "component_ccs",
  "Schema::Bugzilla::4_3_3::Result::component_cc",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::components>

=cut

__PACKAGE__->has_many(
  "components_initialowners",
  "Schema::Bugzilla::4_3_3::Result::components",
...
Related object: L<Schema::Bugzilla::4_3_3::Result::email_setting>

=cut

__PACKAGE__->has_many(
  "email_settings",
  "Schema::Bugzilla::4_3_3::Result::email_setting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::login_failure>

=cut

__PACKAGE__->has_many(
  "login_failures",
  "Schema::Bugzilla::4_3_3::Result::login_failure",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::logincookies>

=cut

__PACKAGE__->has_many(
  "logincookies",
  "Schema::Bugzilla::4_3_3::Result::logincookies",
...
Related object: L<Schema::Bugzilla::4_3_3::Result::longdescs>

=cut

__PACKAGE__->has_many(
  "longdescs",
  "Schema::Bugzilla::4_3_3::Result::longdescs",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::namedqueries>

=cut

__PACKAGE__->has_many(
  "namedqueries",
  "Schema::Bugzilla::4_3_3::Result::namedqueries",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::namedqueries_link_in_footer>

=cut

__PACKAGE__->has_many(
  "namedqueries_links_in_footer",
  "Schema::Bugzilla::4_3_3::Result::namedqueries_link_in_footer",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::profile_search>

=cut

__PACKAGE__->has_many(
  "profile_searches",
  "Schema::Bugzilla::4_3_3::Result::profile_search",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::profile_setting>

=cut

__PACKAGE__->has_many(
  "profile_settings",
  "Schema::Bugzilla::4_3_3::Result::profile_setting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::profiles_activity>

=cut

__PACKAGE__->has_many(
  "profiles_activities_who",
  "Schema::Bugzilla::4_3_3::Result::profiles_activity",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::quips>

=cut

__PACKAGE__->has_many(
  "quips",
  "Schema::Bugzilla::4_3_3::Result::quips",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::reports>

=cut

__PACKAGE__->has_many(
  "reports",
  "Schema::Bugzilla::4_3_3::Result::reports",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::tokens>

=cut

__PACKAGE__->has_many(
  "tokens",
  "Schema::Bugzilla::4_3_3::Result::tokens",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::user_group_map>

=cut

__PACKAGE__->has_many(
  "user_group_maps",
  "Schema::Bugzilla::4_3_3::Result::user_group_map",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:k1PZQ3U4sZHoF5NHUngIMA
