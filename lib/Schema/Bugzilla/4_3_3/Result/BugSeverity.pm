use utf8;
package Schema::Bugzilla::4_3_3::Result::BugSeverity;
...
Schema::Bugzilla::4_3_3::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:01IGRV25oI+escRBQL8TZQ
