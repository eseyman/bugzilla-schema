use utf8;
package Schema::Bugzilla::4_3_3::Result::keyworddefs;
...
Schema::Bugzilla::4_3_3::Result::keyworddefs
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Mlm3vT0st77TxRpjA4NTbA
