use utf8;
package Schema::Bugzilla::4_3_3::Result::flagtypes;
...
Related object: L<Schema::Bugzilla::4_3_3::Result::groups>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kmQWixum1BuJ2C98Ow+/Mw
