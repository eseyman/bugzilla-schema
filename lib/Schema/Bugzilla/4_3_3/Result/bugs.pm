use utf8;
package Schema::Bugzilla::4_3_3::Result::bugs;
...
Related object: L<Schema::Bugzilla::4_3_3::Result::bug_group_map>

=cut

__PACKAGE__->has_many(
  "bug_group_maps",
  "Schema::Bugzilla::4_3_3::Result::bug_group_map",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::bug_tag>

=cut

__PACKAGE__->has_many(
  "bug_tags",
  "Schema::Bugzilla::4_3_3::Result::bug_tag",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::bug_see_also>

=cut

__PACKAGE__->has_many(
  "bugs_see_also",
  "Schema::Bugzilla::4_3_3::Result::bug_see_also",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::dependencies>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::4_3_3::Result::dependencies",
...
Related object: L<Schema::Bugzilla::4_3_3::Result::duplicates>

=cut

__PACKAGE__->might_have(
  "duplicates_dupe",
  "Schema::Bugzilla::4_3_3::Result::duplicates",
...
Related object: L<Schema::Bugzilla::4_3_3::Result::keywords>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::4_3_3::Result::keywords",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_3::Result::products>

=cut

__PACKAGE__->belongs_to(
  "product",
  "Schema::Bugzilla::4_3_3::Result::products",
  { id => "product_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LuTWn2kwKX/7FDwSxLcIlA
