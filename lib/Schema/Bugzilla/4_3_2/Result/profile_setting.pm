use utf8;
package Schema::Bugzilla::4_3_2::Result::profile_setting;
...
Related object: L<Schema::Bugzilla::4_3_2::Result::setting>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aw+B1pMkWoOSu7ObZsXiZA
