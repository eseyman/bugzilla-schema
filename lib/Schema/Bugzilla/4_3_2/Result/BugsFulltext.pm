use utf8;
package Schema::Bugzilla::4_3_2::Result::BugsFulltext;
...
Schema::Bugzilla::4_3_2::Result::BugsFulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1dwqu5BKZAfhT7wsaBwWFQ
