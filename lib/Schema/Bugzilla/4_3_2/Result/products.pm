use utf8;
package Schema::Bugzilla::4_3_2::Result::products;
...
Related object: L<Schema::Bugzilla::4_3_2::Result::classifications>

=cut

__PACKAGE__->belongs_to(
  "classification",
  "Schema::Bugzilla::4_3_2::Result::classifications",
...
Related object: L<Schema::Bugzilla::4_3_2::Result::milestones>

=cut

__PACKAGE__->has_many(
  "milestones",
  "Schema::Bugzilla::4_3_2::Result::milestones",
  { "foreign.product_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_3_2::Result::versions>

=cut

__PACKAGE__->has_many(
  "versions",
  "Schema::Bugzilla::4_3_2::Result::versions",
  { "foreign.product_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:p0Uq2hlyonYMDxCxxGp9og
