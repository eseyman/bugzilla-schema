use utf8;
package Schema::Bugzilla::4_3_2::Result::BugSeverity;
...
Schema::Bugzilla::4_3_2::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Z6SOB3g1ityk7OLZ4hIBcQ
