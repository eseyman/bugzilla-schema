use utf8;
package Schema::Bugzilla::4_3_2::Result::bug_severity;
...
Schema::Bugzilla::4_3_2::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8neQXVowlBQEOd6Boc/cig
