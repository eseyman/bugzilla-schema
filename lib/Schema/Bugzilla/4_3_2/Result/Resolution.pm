use utf8;
package Schema::Bugzilla::4_3_2::Result::Resolution;
...
Schema::Bugzilla::4_3_2::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4jnkuIXs162+cWTG+wJBcA
