use utf8;
package Schema::Bugzilla::4_3_2::Result::SeriesCategory;
...
Schema::Bugzilla::4_3_2::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YkDxolqorPmXI/DKjxiV8Q
