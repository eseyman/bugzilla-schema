use utf8;
package Schema::Bugzilla::4_3_2::Result::TsExitstatus;
...
Schema::Bugzilla::4_3_2::Result::TsExitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pW0IaQlmtFd8R0bcon4ZvQ
