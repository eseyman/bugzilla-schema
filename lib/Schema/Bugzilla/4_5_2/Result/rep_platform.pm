use utf8;
package Schema::Bugzilla::4_5_2::Result::rep_platform;
...
Schema::Bugzilla::4_5_2::Result::rep_platform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:70ZjKm9/vVXvuYXxO0JqIQ
