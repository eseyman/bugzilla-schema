use utf8;
package Schema::Bugzilla::4_5_2::Result::LongdescsTagsWeight;
...
Schema::Bugzilla::4_5_2::Result::LongdescsTagsWeight
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2V1pWYmfZXMMlDTPmllRKg
