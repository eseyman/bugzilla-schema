use utf8;
package Schema::Bugzilla::4_5_2::Result::bugs;
...
Related object: L<Schema::Bugzilla::4_5_2::Result::bug_group_map>

=cut

__PACKAGE__->has_many(
  "bug_group_maps",
  "Schema::Bugzilla::4_5_2::Result::bug_group_map",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_2::Result::bug_tag>

=cut

__PACKAGE__->has_many(
  "bug_tags",
  "Schema::Bugzilla::4_5_2::Result::bug_tag",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_2::Result::bug_see_also>
...
Related object: L<Schema::Bugzilla::4_5_2::Result::dependencies>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::4_5_2::Result::dependencies",
...
Related object: L<Schema::Bugzilla::4_5_2::Result::duplicates>

=cut

__PACKAGE__->might_have(
  "duplicates_dupe",
  "Schema::Bugzilla::4_5_2::Result::duplicates",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8vjd5SIXRWYMKM7h+2jR7w
