use utf8;
package Schema::Bugzilla::4_5_2::Result::SeriesCategory;
...
Schema::Bugzilla::4_5_2::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bFbbgubKlTdBtUz+X2Tlsg
