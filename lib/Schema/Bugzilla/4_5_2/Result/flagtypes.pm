use utf8;
package Schema::Bugzilla::4_5_2::Result::flagtypes;
...
Related object: L<Schema::Bugzilla::4_5_2::Result::groups>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:p0ravx+4edrNRIXB2NBvSw
