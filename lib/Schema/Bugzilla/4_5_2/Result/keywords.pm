use utf8;
package Schema::Bugzilla::4_5_2::Result::keywords;
...
Related object: L<Schema::Bugzilla::4_5_2::Result::keyworddefs>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cJ9MVpmD62C3gQDU/+Z0fQ
