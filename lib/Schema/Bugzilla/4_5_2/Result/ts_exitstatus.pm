use utf8;
package Schema::Bugzilla::4_5_2::Result::ts_exitstatus;
...
Schema::Bugzilla::4_5_2::Result::ts_exitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DKOhs1EgUw6jHRTSGfQxDw
