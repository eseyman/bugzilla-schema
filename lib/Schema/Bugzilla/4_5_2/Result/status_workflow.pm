use utf8;
package Schema::Bugzilla::4_5_2::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::4_5_2::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bViueBLH2fKj/otKn4+trQ
