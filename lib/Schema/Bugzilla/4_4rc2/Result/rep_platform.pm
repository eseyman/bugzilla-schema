use utf8;
package Schema::Bugzilla::4_4rc2::Result::rep_platform;
...
Schema::Bugzilla::4_4rc2::Result::rep_platform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WDOXcd83GTE5IAR5jfP1dw
