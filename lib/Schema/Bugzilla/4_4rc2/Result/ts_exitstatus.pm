use utf8;
package Schema::Bugzilla::4_4rc2::Result::ts_exitstatus;
...
Schema::Bugzilla::4_4rc2::Result::ts_exitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WCCNs/OJhKROx0HwK9/8lA
