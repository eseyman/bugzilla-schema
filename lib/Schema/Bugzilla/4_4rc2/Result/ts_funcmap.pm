use utf8;
package Schema::Bugzilla::4_4rc2::Result::ts_funcmap;
...
Schema::Bugzilla::4_4rc2::Result::ts_funcmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:9JrjGc/PW86aDjfW1TjX+Q
