use utf8;
package Schema::Bugzilla::4_4rc2::Result::Fielddef;
...
Related object: L<Schema::Bugzilla::4_4rc2::Result::FieldVisibility>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AENWdxZ7um5yvWeOmhruIQ
