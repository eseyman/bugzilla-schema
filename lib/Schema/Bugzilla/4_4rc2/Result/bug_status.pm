use utf8;
package Schema::Bugzilla::4_4rc2::Result::bug_status;
...
Related object: L<Schema::Bugzilla::4_4rc2::Result::status_workflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:K07MFtylTr+gW2khuXkf3w
