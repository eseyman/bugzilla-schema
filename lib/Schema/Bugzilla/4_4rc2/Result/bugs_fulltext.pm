use utf8;
package Schema::Bugzilla::4_4rc2::Result::bugs_fulltext;
...
Schema::Bugzilla::4_4rc2::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:c+5kmWkUQJ0k3UaoiloVEQ
