use utf8;
package Schema::Bugzilla::4_4rc2::Result::bz_schema;
...
Schema::Bugzilla::4_4rc2::Result::bz_schema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6994bdQOqSBNNwOwsmAgLQ
