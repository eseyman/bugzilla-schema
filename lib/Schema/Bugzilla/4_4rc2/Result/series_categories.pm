use utf8;
package Schema::Bugzilla::4_4rc2::Result::series_categories;
...
Schema::Bugzilla::4_4rc2::Result::series_categories
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FUsVviss0gjWhpgPb+6hQA
