use utf8;
package Schema::Bugzilla::4_4rc2::Result::BugsFulltext;
...
Schema::Bugzilla::4_4rc2::Result::BugsFulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tgb7GvsIb/F4iwgPrLjA4w
