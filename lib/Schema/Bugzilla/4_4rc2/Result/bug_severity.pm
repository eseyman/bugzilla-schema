use utf8;
package Schema::Bugzilla::4_4rc2::Result::bug_severity;
...
Schema::Bugzilla::4_4rc2::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:krAjd+qjLMm34El8RkDnlQ
