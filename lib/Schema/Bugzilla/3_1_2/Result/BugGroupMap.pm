use utf8;
package Schema::Bugzilla::3_1_2::Result::BugGroupMap;
...
Schema::Bugzilla::3_1_2::Result::BugGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:b2DJEoUGE+UJhRoPGAwqsw
