use utf8;
package Schema::Bugzilla::3_1_2::Result::keyworddefs;
...
Schema::Bugzilla::3_1_2::Result::keyworddefs
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:55UQ//cIV4yt3czxNeubSA
