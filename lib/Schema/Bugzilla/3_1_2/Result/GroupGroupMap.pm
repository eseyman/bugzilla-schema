use utf8;
package Schema::Bugzilla::3_1_2::Result::GroupGroupMap;
...
Schema::Bugzilla::3_1_2::Result::GroupGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aO67FVmx+XwogPUs7W/ncw
