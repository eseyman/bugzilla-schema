use utf8;
package Schema::Bugzilla::3_1_2::Result::ProfileSetting;
...
Schema::Bugzilla::3_1_2::Result::ProfileSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1WsvuGz4E6la3+DeAzSSfw
