use utf8;
package Schema::Bugzilla::3_1_2::Result::EmailSetting;
...
Schema::Bugzilla::3_1_2::Result::EmailSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:da+nKbcDzULqYh/poJSKDg
