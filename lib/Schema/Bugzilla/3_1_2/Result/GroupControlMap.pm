use utf8;
package Schema::Bugzilla::3_1_2::Result::GroupControlMap;
...
Schema::Bugzilla::3_1_2::Result::GroupControlMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KVa3lh/K9fYS0bRYvLORBQ
