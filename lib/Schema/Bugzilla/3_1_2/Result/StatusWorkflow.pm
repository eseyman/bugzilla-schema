use utf8;
package Schema::Bugzilla::3_1_2::Result::StatusWorkflow;
...
Schema::Bugzilla::3_1_2::Result::StatusWorkflow
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0dlvVz3Ao2IxstFYbErKaA
