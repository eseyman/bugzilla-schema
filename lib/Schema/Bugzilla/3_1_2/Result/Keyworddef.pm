use utf8;
package Schema::Bugzilla::3_1_2::Result::Keyworddef;
...
Schema::Bugzilla::3_1_2::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ApsnyxQ8Em/QPmsvmr9S4w
