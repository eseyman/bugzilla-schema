use utf8;
package Schema::Bugzilla::3_1_2::Result::status_workflow;
...
Schema::Bugzilla::3_1_2::Result::status_workflow
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:meWC72T1DOkar4E5ugnMsg
