use utf8;
package Schema::Bugzilla::3_1_2::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_1_2::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:COEdmsHv9x2C/bjxvPwb+Q
