use utf8;
package Schema::Bugzilla::3_1_2::Result::Classification;
...
Schema::Bugzilla::3_1_2::Result::Classification
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tBFyLCX6dUUKpeIHhFnM+w
