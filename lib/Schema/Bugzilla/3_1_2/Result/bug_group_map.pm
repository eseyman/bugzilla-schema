use utf8;
package Schema::Bugzilla::3_1_2::Result::bug_group_map;
...
Schema::Bugzilla::3_1_2::Result::bug_group_map
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iwiysZ/klmCHbESP8REq9A
