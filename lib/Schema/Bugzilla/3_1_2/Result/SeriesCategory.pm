use utf8;
package Schema::Bugzilla::3_1_2::Result::SeriesCategory;
...
Schema::Bugzilla::3_1_2::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HXOzcjRWfJQHcqDYlRdfUA
