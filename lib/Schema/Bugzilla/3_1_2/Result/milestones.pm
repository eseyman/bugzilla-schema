use utf8;
package Schema::Bugzilla::3_1_2::Result::milestones;
...
Schema::Bugzilla::3_1_2::Result::milestones
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zJwQCAtjSylc/4ZjyyrtQQ
