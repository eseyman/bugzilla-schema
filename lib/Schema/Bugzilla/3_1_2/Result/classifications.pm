use utf8;
package Schema::Bugzilla::3_1_2::Result::classifications;
...
Schema::Bugzilla::3_1_2::Result::classifications
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ifIMys3HmJubLtmayPQhSg
