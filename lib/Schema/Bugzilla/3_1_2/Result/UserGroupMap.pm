use utf8;
package Schema::Bugzilla::3_1_2::Result::UserGroupMap;
...
Schema::Bugzilla::3_1_2::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CANyAdcRRhS57pMDQj1xig
