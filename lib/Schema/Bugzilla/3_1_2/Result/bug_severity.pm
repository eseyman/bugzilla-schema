use utf8;
package Schema::Bugzilla::3_1_2::Result::bug_severity;
...
Schema::Bugzilla::3_1_2::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aNVo0S2Hz/3LHwqzALl8MA
