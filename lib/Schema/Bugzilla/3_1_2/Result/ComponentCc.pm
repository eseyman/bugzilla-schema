use utf8;
package Schema::Bugzilla::3_1_2::Result::ComponentCc;
...
Schema::Bugzilla::3_1_2::Result::ComponentCc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GrtCKCpaejkhJ8A5AUb3sg
