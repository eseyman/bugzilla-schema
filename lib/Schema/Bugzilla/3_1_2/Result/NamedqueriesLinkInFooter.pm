use utf8;
package Schema::Bugzilla::3_1_2::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::3_1_2::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nk/pOCjzkqawxSNarb2hCA
