use utf8;
package Schema::Bugzilla::3_1_4::Result::flagtypes;
...
Schema::Bugzilla::3_1_4::Result::flagtypes
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2rGENDnt/1XRJ8ZWibylYA
