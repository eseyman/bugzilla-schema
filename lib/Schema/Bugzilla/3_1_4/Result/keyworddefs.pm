use utf8;
package Schema::Bugzilla::3_1_4::Result::keyworddefs;
...
Schema::Bugzilla::3_1_4::Result::keyworddefs
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:P9x3hbAs6ZVD3aGuODfZlA
