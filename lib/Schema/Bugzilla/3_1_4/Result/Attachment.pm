use utf8;
package Schema::Bugzilla::3_1_4::Result::Attachment;
...
Schema::Bugzilla::3_1_4::Result::Attachment
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DqLKUl+guqTjOWxw4zfklg
