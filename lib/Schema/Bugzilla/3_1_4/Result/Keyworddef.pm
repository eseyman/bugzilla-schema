use utf8;
package Schema::Bugzilla::3_1_4::Result::Keyworddef;
...
Schema::Bugzilla::3_1_4::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SxGu99ofnlSzH8oEu+1uug
