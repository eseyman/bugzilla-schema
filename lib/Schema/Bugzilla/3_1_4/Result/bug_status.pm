use utf8;
package Schema::Bugzilla::3_1_4::Result::bug_status;
...
Schema::Bugzilla::3_1_4::Result::bug_status
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZRki6ZsKrZtBeHYiNixc5g
