use utf8;
package Schema::Bugzilla::3_1_4::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_1_4::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:at4WeXgRKvOiheDplH1QmQ
