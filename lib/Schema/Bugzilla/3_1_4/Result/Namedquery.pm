use utf8;
package Schema::Bugzilla::3_1_4::Result::Namedquery;
...
Schema::Bugzilla::3_1_4::Result::Namedquery
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ajDzhSXdBuzSWDXdtHkv6Q
