use utf8;
package Schema::Bugzilla::3_1_4::Result::BugsFulltext;
...
Schema::Bugzilla::3_1_4::Result::BugsFulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+7y2uHVvF8sr0FhSo1YZwQ
