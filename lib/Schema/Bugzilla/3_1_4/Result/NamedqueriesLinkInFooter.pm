use utf8;
package Schema::Bugzilla::3_1_4::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::3_1_4::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zVChB+XBPRYYhPKoJxy0DQ
