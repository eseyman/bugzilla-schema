use utf8;
package Schema::Bugzilla::5_0_5::Result::StatusWorkflow;
...
Schema::Bugzilla::5_0_5::Result::StatusWorkflow
...
Related object: L<Schema::Bugzilla::5_0_5::Result::BugStatus>

=cut

__PACKAGE__->belongs_to(
  "new_status",
  "Schema::Bugzilla::5_0_5::Result::BugStatus",
  { id => "new_status" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IglZEVXJg/xJ69Yt+ghbpQ
