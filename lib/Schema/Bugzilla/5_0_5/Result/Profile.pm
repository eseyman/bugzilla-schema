use utf8;
package Schema::Bugzilla::5_0_5::Result::Profile;
...
Related object: L<Schema::Bugzilla::5_0_5::Result::AuditLog>

=cut

__PACKAGE__->has_many(
  "audit_logs",
  "Schema::Bugzilla::5_0_5::Result::AuditLog",
...
Related object: L<Schema::Bugzilla::5_0_5::Result::BugUserLastVisit>

=cut

__PACKAGE__->has_many(
  "bug_user_last_visits",
  "Schema::Bugzilla::5_0_5::Result::BugUserLastVisit",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::BugsActivity>

=cut

__PACKAGE__->has_many(
  "bugs_activities",
  "Schema::Bugzilla::5_0_5::Result::BugsActivity",
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Cc>

=cut

__PACKAGE__->has_many(
  "ccs",
  "Schema::Bugzilla::5_0_5::Result::Cc",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::ComponentCc>
...
Related object: L<Schema::Bugzilla::5_0_5::Result::EmailBugIgnore>

=cut

__PACKAGE__->has_many(
  "email_bugs_ignore",
  "Schema::Bugzilla::5_0_5::Result::EmailBugIgnore",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::EmailSetting>

=cut

__PACKAGE__->has_many(
  "email_settings",
  "Schema::Bugzilla::5_0_5::Result::EmailSetting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Flag>

=cut

__PACKAGE__->has_many(
  "flags_requestees",
  "Schema::Bugzilla::5_0_5::Result::Flag",
...
Related object: L<Schema::Bugzilla::5_0_5::Result::LoginFailure>

=cut

__PACKAGE__->has_many(
  "login_failures",
  "Schema::Bugzilla::5_0_5::Result::LoginFailure",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Logincooky>

=cut

__PACKAGE__->has_many(
  "logincookies",
  "Schema::Bugzilla::5_0_5::Result::Logincooky",
...
Related object: L<Schema::Bugzilla::5_0_5::Result::LongdescsTagsActivity>

=cut

__PACKAGE__->has_many(
  "longdescs_tags_activities",
  "Schema::Bugzilla::5_0_5::Result::LongdescsTagsActivity",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::NamedqueriesLinkInFooter>
...
Related object: L<Schema::Bugzilla::5_0_5::Result::ProfileSearch>
...
Related object: L<Schema::Bugzilla::5_0_5::Result::ProfilesActivity>
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Quip>

=cut

__PACKAGE__->has_many(
  "quips",
  "Schema::Bugzilla::5_0_5::Result::Quip",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Report>

=cut

__PACKAGE__->has_many(
  "reports",
  "Schema::Bugzilla::5_0_5::Result::Report",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Series>

=cut

__PACKAGE__->has_many(
  "series",
  "Schema::Bugzilla::5_0_5::Result::Series",
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Tag>

=cut

__PACKAGE__->has_many(
  "tags",
  "Schema::Bugzilla::5_0_5::Result::Tag",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Token>

=cut

__PACKAGE__->has_many(
  "tokens",
  "Schema::Bugzilla::5_0_5::Result::Token",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::UserApiKey>
...
Related object: L<Schema::Bugzilla::5_0_5::Result::UserGroupMap>

=cut

__PACKAGE__->has_many(
  "user_group_maps",
  "Schema::Bugzilla::5_0_5::Result::UserGroupMap",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Watch>

=cut

__PACKAGE__->has_many(
  "watch_watchers",
  "Schema::Bugzilla::5_0_5::Result::Watch",
...
Related object: L<Schema::Bugzilla::5_0_5::Result::WhineEvent>

=cut

__PACKAGE__->has_many(
  "whine_events",
  "Schema::Bugzilla::5_0_5::Result::WhineEvent",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TATBwf0/xLTv4moApgy/Qw
