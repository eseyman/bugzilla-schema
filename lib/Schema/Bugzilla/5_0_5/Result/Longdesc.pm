use utf8;
package Schema::Bugzilla::5_0_5::Result::Longdesc;
...
Related object: L<Schema::Bugzilla::5_0_5::Result::LongdescsTag>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QACcbjQfidAJiYhQYRW9jw
