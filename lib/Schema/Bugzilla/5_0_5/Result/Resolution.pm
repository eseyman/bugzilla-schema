use utf8;
package Schema::Bugzilla::5_0_5::Result::Resolution;
...
Schema::Bugzilla::5_0_5::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2PEZngTkxVG3wEUR/fpddA
