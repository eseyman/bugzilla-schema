use utf8;
package Schema::Bugzilla::5_0_5::Result::BugStatus;
...
Related object: L<Schema::Bugzilla::5_0_5::Result::StatusWorkflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UKMIbrKGmGLjjM7LFU0wlw
