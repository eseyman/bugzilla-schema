use utf8;
package Schema::Bugzilla::5_0_5::Result::Attachment;
...
Related object: L<Schema::Bugzilla::5_0_5::Result::AttachData>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:URfDFs4hFJirby/1bwiTFw
