use utf8;
package Schema::Bugzilla::5_0_5::Result::ProfileSetting;
...
Related object: L<Schema::Bugzilla::5_0_5::Result::Setting>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:9zQDfDm+rUbKCgNJM4pCZw
