use utf8;
package Schema::Bugzilla::5_0_5::Result::TsFuncmap;
...
Schema::Bugzilla::5_0_5::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5RVxaW+nJQWmMugkcFYsXg
