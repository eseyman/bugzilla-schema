use utf8;
package Schema::Bugzilla::5_0_5::Result::Fielddef;
...
Related object: L<Schema::Bugzilla::5_0_5::Result::FieldVisibility>

=cut

__PACKAGE__->has_many(
  "field_visibilities",
  "Schema::Bugzilla::5_0_5::Result::FieldVisibility",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DG3s/qQFgYdKT4dvtErpbA
