use utf8;
package Schema::Bugzilla::2_18rc3::Result::components;
...
Schema::Bugzilla::2_18rc3::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZnLFkvY8ikwb5/2HPweqfg
