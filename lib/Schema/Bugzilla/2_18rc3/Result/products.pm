use utf8;
package Schema::Bugzilla::2_18rc3::Result::products;
...
Schema::Bugzilla::2_18rc3::Result::products
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eMKL0Jfn+Pin1hmoZVECJQ
