use utf8;
package Schema::Bugzilla::4_5_6::Result::bz_schema;
...
Schema::Bugzilla::4_5_6::Result::bz_schema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ToNJCAbLfhZnlgyDcO2CSQ
