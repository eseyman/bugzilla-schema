use utf8;
package Schema::Bugzilla::4_5_6::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::4_5_6::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:St+MbKlAF7ScYCUqZY7fgg
