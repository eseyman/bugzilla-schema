use utf8;
package Schema::Bugzilla::4_5_6::Result::keywords;
...
Related object: L<Schema::Bugzilla::4_5_6::Result::keyworddefs>

=cut

__PACKAGE__->belongs_to(
  "keywordid",
  "Schema::Bugzilla::4_5_6::Result::keyworddefs",
  { id => "keywordid" },
  { is_deferrable => 1, on_delete => "CASCADE", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iidXDAPeFdxQS52i4M3qcQ
