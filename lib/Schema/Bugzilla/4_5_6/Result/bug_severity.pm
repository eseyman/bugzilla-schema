use utf8;
package Schema::Bugzilla::4_5_6::Result::bug_severity;
...
Schema::Bugzilla::4_5_6::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XqOaHFZtBq9F3wCq8McUtw
