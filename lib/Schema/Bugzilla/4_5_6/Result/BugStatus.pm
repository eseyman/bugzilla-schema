use utf8;
package Schema::Bugzilla::4_5_6::Result::BugStatus;
...
Related object: L<Schema::Bugzilla::4_5_6::Result::StatusWorkflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eGTPFJuNsobOVe/z5DdpMg
