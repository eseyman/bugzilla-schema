use utf8;
package Schema::Bugzilla::4_5_6::Result::fielddefs;
...
Related object: L<Schema::Bugzilla::4_5_6::Result::field_visibility>

=cut

__PACKAGE__->has_many(
  "field_visibilities",
  "Schema::Bugzilla::4_5_6::Result::field_visibility",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aXRx92GCytH70HkM1qwfDg
