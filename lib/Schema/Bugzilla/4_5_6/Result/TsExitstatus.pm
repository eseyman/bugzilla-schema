use utf8;
package Schema::Bugzilla::4_5_6::Result::TsExitstatus;
...
Schema::Bugzilla::4_5_6::Result::TsExitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ogjUO055iPRuF/nOvTc3aw
