use utf8;
package Schema::Bugzilla::4_5_6::Result::longdescs;
...
Related object: L<Schema::Bugzilla::4_5_6::Result::longdescs_tags>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XkQutqzcpQddYLG4XyRHpw
