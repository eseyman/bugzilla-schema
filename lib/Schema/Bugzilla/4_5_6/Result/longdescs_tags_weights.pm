use utf8;
package Schema::Bugzilla::4_5_6::Result::longdescs_tags_weights;
...
Schema::Bugzilla::4_5_6::Result::longdescs_tags_weights
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dMR02xCV8aAtGmZcN3y8rw
