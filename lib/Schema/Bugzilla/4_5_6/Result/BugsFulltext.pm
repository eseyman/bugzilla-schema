use utf8;
package Schema::Bugzilla::4_5_6::Result::BugsFulltext;
...
Schema::Bugzilla::4_5_6::Result::BugsFulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Bebtsc1tWsiD2aSB56Wrww
