use utf8;
package Schema::Bugzilla::4_5_6::Result::SeriesCategory;
...
Schema::Bugzilla::4_5_6::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MAyr+BSZGt7A+iL75lW7CQ
