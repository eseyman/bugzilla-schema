use utf8;
package Schema::Bugzilla::4_5_6::Result::series_categories;
...
Schema::Bugzilla::4_5_6::Result::series_categories
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:fW2+wMzFykDY6p2auKjjvg
