use utf8;
package Schema::Bugzilla::2_8::Result::logincookies;
...
Schema::Bugzilla::2_8::Result::logincookies
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:b78/iV8plVD3cSeAFaW+Sw
