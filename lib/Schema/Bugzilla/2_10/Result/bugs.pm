use utf8;
package Schema::Bugzilla::2_10::Result::bugs;
...
Schema::Bugzilla::2_10::Result::bugs
...
=head2 op_sys
  ...
  data_type: 'enum'
  extra: {list => ["All","Windows 3.1","Windows 95","Windows 98","Windows 2000","Windows NT","Mac System 7","Mac System 7.5","Mac System 7.6.1","Mac System 8.0","Mac System 8.5","Mac System 8.6","Mac System 9.0","AIX","BSDI","HP-UX","IRIX","Linux","FreeBSD","OSF/1","Solaris","SunOS","Neutrino","OS/2","BeOS","OpenVMS","other"]}
  is_nullable: 0
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:v9Z0PkjzSv58PiUV2FblcQ
