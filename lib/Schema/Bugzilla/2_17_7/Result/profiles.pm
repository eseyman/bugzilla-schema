use utf8;
package Schema::Bugzilla::2_17_7::Result::profiles;
...
Schema::Bugzilla::2_17_7::Result::profiles
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QK1JsaygiO0MclTTKyBrqA
