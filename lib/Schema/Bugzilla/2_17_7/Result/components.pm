use utf8;
package Schema::Bugzilla::2_17_7::Result::components;
...
Schema::Bugzilla::2_17_7::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HLv/grv/R+6BECeu7l8mew
