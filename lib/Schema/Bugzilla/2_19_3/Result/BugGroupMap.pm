use utf8;
package Schema::Bugzilla::2_19_3::Result::BugGroupMap;
...
Schema::Bugzilla::2_19_3::Result::BugGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:if7KwaMB+2L9r6gfnLcokQ
