use utf8;
package Schema::Bugzilla::2_19_3::Result::bug_severity;
...
Schema::Bugzilla::2_19_3::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LKBFuvVre+qdYNhP6hYifg
