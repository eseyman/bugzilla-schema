use utf8;
package Schema::Bugzilla::2_19_3::Result::user_group_map;
...
Schema::Bugzilla::2_19_3::Result::user_group_map
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:l8QknXI+IoVDvMmsaeRDgg
