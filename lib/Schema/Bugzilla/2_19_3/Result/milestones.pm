use utf8;
package Schema::Bugzilla::2_19_3::Result::milestones;
...
Schema::Bugzilla::2_19_3::Result::milestones
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZcDqF6+SZecKkzVJIcDFQg
