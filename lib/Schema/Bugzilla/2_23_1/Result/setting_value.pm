use utf8;
package Schema::Bugzilla::2_23_1::Result::setting_value;
...
Schema::Bugzilla::2_23_1::Result::setting_value
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+fcBVpQUQdHWSDs/ta/MAw
