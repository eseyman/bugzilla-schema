use utf8;
package Schema::Bugzilla::2_23_1::Result::bug_status;
...
Schema::Bugzilla::2_23_1::Result::bug_status
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6dayptmNH5+beLr/TjFgpQ
