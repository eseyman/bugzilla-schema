use utf8;
package Schema::Bugzilla::2_23_2::Result::profiles;
...
Schema::Bugzilla::2_23_2::Result::profiles
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VkkhDK6UbxyREh+iHANnlQ
