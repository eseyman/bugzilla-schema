use utf8;
package Schema::Bugzilla::2_23_2::Result::classifications;
...
Schema::Bugzilla::2_23_2::Result::classifications
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Df+m/v+hErUMAuUO2FYjeQ
