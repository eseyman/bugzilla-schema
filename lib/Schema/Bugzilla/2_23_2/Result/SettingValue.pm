use utf8;
package Schema::Bugzilla::2_23_2::Result::SettingValue;
...
Schema::Bugzilla::2_23_2::Result::SettingValue
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bT8vh+IbCW5lJsdbkoZRMQ
