use utf8;
package Schema::Bugzilla::2_17_3::Result::keywords;
...
Schema::Bugzilla::2_17_3::Result::keywords
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OHppygdGiceo+R5sJHL/SA
