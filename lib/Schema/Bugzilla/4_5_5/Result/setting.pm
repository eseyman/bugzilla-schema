use utf8;
package Schema::Bugzilla::4_5_5::Result::setting;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::setting_value>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HW6fIdtZToHGV6YnI9wjbQ
