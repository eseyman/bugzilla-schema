use utf8;
package Schema::Bugzilla::4_5_5::Result::Keyworddef;
...
Schema::Bugzilla::4_5_5::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Sj+aA0xbOnB3wWjhCLPd9g
