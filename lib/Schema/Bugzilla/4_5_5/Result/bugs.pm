use utf8;
package Schema::Bugzilla::4_5_5::Result::bugs;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::profiles>
...
Related object: L<Schema::Bugzilla::4_5_5::Result::bug_group_map>

=cut

__PACKAGE__->has_many(
  "bug_group_maps",
  "Schema::Bugzilla::4_5_5::Result::bug_group_map",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_5::Result::bug_tag>

=cut

__PACKAGE__->has_many(
  "bug_tags",
  "Schema::Bugzilla::4_5_5::Result::bug_tag",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_5::Result::bug_see_also>

=cut

__PACKAGE__->has_many(
  "bugs_see_also",
  "Schema::Bugzilla::4_5_5::Result::bug_see_also",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_5::Result::dependencies>
...
Related object: L<Schema::Bugzilla::4_5_5::Result::duplicates>
...
Related object: L<Schema::Bugzilla::4_5_5::Result::keywords>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::4_5_5::Result::keywords",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_5::Result::products>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7fXnbLPt4FKuc3g7SpZTIQ
