use utf8;
package Schema::Bugzilla::4_5_5::Result::profile_setting;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::setting>

=cut

__PACKAGE__->belongs_to(
  "setting_name",
  "Schema::Bugzilla::4_5_5::Result::setting",
  { name => "setting_name" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jYvtheYnDRRhAog01QRSyg
