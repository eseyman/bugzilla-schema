use utf8;
package Schema::Bugzilla::4_5_5::Result::StatusWorkflow;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::BugStatus>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TqLDIr6BrLzyytz0IdvYYw
