use utf8;
package Schema::Bugzilla::4_5_5::Result::bugs_fulltext;
...
Schema::Bugzilla::4_5_5::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/GmRE40qo5hX7s2HoxzilA
