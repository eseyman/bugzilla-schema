use utf8;
package Schema::Bugzilla::4_5_5::Result::Bug;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::Profile>
...
Related object: L<Schema::Bugzilla::4_5_5::Result::BugGroupMap>

=cut

__PACKAGE__->has_many(
  "bug_group_maps",
  "Schema::Bugzilla::4_5_5::Result::BugGroupMap",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_5::Result::BugTag>

=cut

__PACKAGE__->has_many(
  "bug_tags",
  "Schema::Bugzilla::4_5_5::Result::BugTag",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_5::Result::BugSeeAlso>

=cut

__PACKAGE__->has_many(
  "bugs_see_also",
  "Schema::Bugzilla::4_5_5::Result::BugSeeAlso",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_5::Result::Dependency>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::4_5_5::Result::Dependency",
...
Related object: L<Schema::Bugzilla::4_5_5::Result::Duplicate>

=cut

__PACKAGE__->might_have(
  "duplicates_dupe",
  "Schema::Bugzilla::4_5_5::Result::Duplicate",
...
Related object: L<Schema::Bugzilla::4_5_5::Result::Keyword>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::4_5_5::Result::Keyword",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_5::Result::Product>

=cut

__PACKAGE__->belongs_to(
  "product",
  "Schema::Bugzilla::4_5_5::Result::Product",
  { id => "product_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2fvFSjH1Z6Gp8Hhk2FLybA
