use utf8;
package Schema::Bugzilla::4_5_5::Result::Series;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::SeriesCategory>

=cut

__PACKAGE__->belongs_to(
  "category",
  "Schema::Bugzilla::4_5_5::Result::SeriesCategory",
  { id => "category" },
...
Related object: L<Schema::Bugzilla::4_5_5::Result::SeriesData>

=cut

__PACKAGE__->has_many(
  "series_datas",
  "Schema::Bugzilla::4_5_5::Result::SeriesData",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oB13CMwsHRn6kn8OWEtQgg
