use utf8;
package Schema::Bugzilla::4_5_5::Result::bug_status;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::status_workflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UrZrengwpGPDCtH3s8J68g
