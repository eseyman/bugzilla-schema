use utf8;
package Schema::Bugzilla::4_5_5::Result::attachments;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::attach_data>

=cut

__PACKAGE__->might_have(
  "attach_data",
  "Schema::Bugzilla::4_5_5::Result::attach_data",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:if77C+eKAbhn8GDsaYgMnQ
