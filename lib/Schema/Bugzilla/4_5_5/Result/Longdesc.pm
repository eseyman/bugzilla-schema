use utf8;
package Schema::Bugzilla::4_5_5::Result::Longdesc;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::LongdescsTag>

=cut

__PACKAGE__->has_many(
  "longdescs_tags",
  "Schema::Bugzilla::4_5_5::Result::LongdescsTag",
  { "foreign.comment_id" => "self.comment_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sxWv1UCMcRU7HIO/PpNPNw
