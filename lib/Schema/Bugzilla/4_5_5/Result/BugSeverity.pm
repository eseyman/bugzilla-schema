use utf8;
package Schema::Bugzilla::4_5_5::Result::BugSeverity;
...
Schema::Bugzilla::4_5_5::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:I9DGncRZVKER0+bvGfSyPw
