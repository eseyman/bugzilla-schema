use utf8;
package Schema::Bugzilla::4_5_5::Result::groups;
...
Related object: L<Schema::Bugzilla::4_5_5::Result::flagtypes>

=cut

__PACKAGE__->has_many(
  "flagtypes_grant_groups",
  "Schema::Bugzilla::4_5_5::Result::flagtypes",
...
Related object: L<Schema::Bugzilla::4_5_5::Result::group_group_map>

=cut

__PACKAGE__->has_many(
  "group_group_map_grantors",
  "Schema::Bugzilla::4_5_5::Result::group_group_map",
...
Related object: L<Schema::Bugzilla::4_5_5::Result::namedquery_group_map>

=cut

__PACKAGE__->has_many(
  "namedquery_group_maps",
  "Schema::Bugzilla::4_5_5::Result::namedquery_group_map",
  { "foreign.group_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6qVATgcernJz5AZUggJE9A
