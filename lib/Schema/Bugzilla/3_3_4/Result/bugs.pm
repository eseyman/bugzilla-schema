use utf8;
package Schema::Bugzilla::3_3_4::Result::bugs;
...
Schema::Bugzilla::3_3_4::Result::bugs
...
Related object: L<Schema::Bugzilla::3_3_4::Result::dependencies>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::3_3_4::Result::dependencies",
...
Related object: L<Schema::Bugzilla::3_3_4::Result::duplicates>

=cut

__PACKAGE__->might_have(
  "duplicates_dupe",
  "Schema::Bugzilla::3_3_4::Result::duplicates",
...
Related object: L<Schema::Bugzilla::3_3_4::Result::keywords>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::3_3_4::Result::keywords",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XTS16YGqboI/oU0xMovOmA
