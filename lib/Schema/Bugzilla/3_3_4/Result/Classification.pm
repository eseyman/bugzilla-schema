use utf8;
package Schema::Bugzilla::3_3_4::Result::Classification;
...
Schema::Bugzilla::3_3_4::Result::Classification
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OvMaD4WmCUUpUe1s3uTUTw
