use utf8;
package Schema::Bugzilla::3_3_4::Result::Milestone;
...
Schema::Bugzilla::3_3_4::Result::Milestone
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tG+m75vZS4XbChAmwnBRSQ
