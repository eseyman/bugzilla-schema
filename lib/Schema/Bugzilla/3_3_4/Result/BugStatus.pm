use utf8;
package Schema::Bugzilla::3_3_4::Result::BugStatus;
...
Schema::Bugzilla::3_3_4::Result::BugStatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:wN6hZ6m5ZkOaNsuFTUjdNw
