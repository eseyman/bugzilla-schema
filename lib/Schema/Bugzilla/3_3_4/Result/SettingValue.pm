use utf8;
package Schema::Bugzilla::3_3_4::Result::SettingValue;
...
Schema::Bugzilla::3_3_4::Result::SettingValue
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:woQI+MfOOJoSjjf9tBYOkg
