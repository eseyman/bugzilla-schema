use utf8;
package Schema::Bugzilla::3_3_4::Result::ComponentCc;
...
Schema::Bugzilla::3_3_4::Result::ComponentCc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iqD5jc/cAJMEJoGYtV9+zQ
