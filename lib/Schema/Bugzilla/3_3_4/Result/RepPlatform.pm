use utf8;
package Schema::Bugzilla::3_3_4::Result::RepPlatform;
...
Schema::Bugzilla::3_3_4::Result::RepPlatform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:H2+ELvdzNmpfPtdJZYEy6Q
