use utf8;
package Schema::Bugzilla::3_3_4::Result::TsExitstatus;
...
Schema::Bugzilla::3_3_4::Result::TsExitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dx4DK5VHkeAGcQnXkvcE2w
