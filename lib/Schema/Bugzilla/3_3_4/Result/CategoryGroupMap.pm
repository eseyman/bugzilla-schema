use utf8;
package Schema::Bugzilla::3_3_4::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_3_4::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:k2uoVcxVwwCvrn//6PIZkQ
