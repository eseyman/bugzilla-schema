use utf8;
package Schema::Bugzilla::3_3_4::Result::SeriesCategory;
...
Schema::Bugzilla::3_3_4::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Nii+gCvbzDLIoQzvaqugaw
