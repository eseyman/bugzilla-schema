use utf8;
package Schema::Bugzilla::3_3_4::Result::ProfileSetting;
...
Schema::Bugzilla::3_3_4::Result::ProfileSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QMMS/B86eAve0IGwxZfAvw
