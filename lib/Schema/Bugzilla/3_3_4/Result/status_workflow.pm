use utf8;
package Schema::Bugzilla::3_3_4::Result::status_workflow;
...
Schema::Bugzilla::3_3_4::Result::status_workflow
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xFcghCXokqD5CyQtIKmbew
