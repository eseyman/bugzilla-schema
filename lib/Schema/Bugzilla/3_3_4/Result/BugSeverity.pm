use utf8;
package Schema::Bugzilla::3_3_4::Result::BugSeverity;
...
Schema::Bugzilla::3_3_4::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:N+i1fkTqpF9cTXfWzZimyw
