use utf8;
package Schema::Bugzilla::3_3_4::Result::Keyworddef;
...
Schema::Bugzilla::3_3_4::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kL3wfHVYeL90u3kNF5ATxg
