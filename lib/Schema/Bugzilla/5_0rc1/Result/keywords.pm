use utf8;
package Schema::Bugzilla::5_0rc1::Result::keywords;
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::keyworddefs>

=cut

__PACKAGE__->belongs_to(
  "keywordid",
  "Schema::Bugzilla::5_0rc1::Result::keyworddefs",
  { id => "keywordid" },
  { is_deferrable => 1, on_delete => "CASCADE", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CQhJsn1P5boJBgM8wB85TA
