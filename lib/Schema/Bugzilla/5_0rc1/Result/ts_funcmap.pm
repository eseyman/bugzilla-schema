use utf8;
package Schema::Bugzilla::5_0rc1::Result::ts_funcmap;
...
Schema::Bugzilla::5_0rc1::Result::ts_funcmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ozmB3OXOIE933Rlh9mWAcw
