use utf8;
package Schema::Bugzilla::5_0rc1::Result::priority;
...
Schema::Bugzilla::5_0rc1::Result::priority
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WNRvNqijGZvJBjz0rL8SNw
