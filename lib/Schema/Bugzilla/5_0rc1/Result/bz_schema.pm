use utf8;
package Schema::Bugzilla::5_0rc1::Result::bz_schema;
...
Schema::Bugzilla::5_0rc1::Result::bz_schema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hROureBo2/vqzwPXuhq4DA
