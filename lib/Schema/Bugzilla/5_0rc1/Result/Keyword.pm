use utf8;
package Schema::Bugzilla::5_0rc1::Result::Keyword;
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Keyworddef>

=cut

__PACKAGE__->belongs_to(
  "keywordid",
  "Schema::Bugzilla::5_0rc1::Result::Keyworddef",
  { id => "keywordid" },
  { is_deferrable => 1, on_delete => "CASCADE", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YIA0BG7rS+8sbAVtLAOuRQ
