use utf8;
package Schema::Bugzilla::5_0rc1::Result::bug_severity;
...
Schema::Bugzilla::5_0rc1::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gTe5+Pi3zDoSE5q6+hQFrQ
