use utf8;
package Schema::Bugzilla::5_0rc1::Result::ts_exitstatus;
...
Schema::Bugzilla::5_0rc1::Result::ts_exitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sEkPeYmLguU3XsDMKTee6A
