use utf8;
package Schema::Bugzilla::5_0rc1::Result::Group;
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::CategoryGroupMap>
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Flagtype>

=cut

__PACKAGE__->has_many(
  "flagtypes_grant_groups",
  "Schema::Bugzilla::5_0rc1::Result::Flagtype",
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::GroupGroupMap>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:j/Hln91t6d9g7eh3ry7NCg
