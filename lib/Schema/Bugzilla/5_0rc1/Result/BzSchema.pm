use utf8;
package Schema::Bugzilla::5_0rc1::Result::BzSchema;
...
Schema::Bugzilla::5_0rc1::Result::BzSchema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KqQUMmjIn9NfLANdPSchqw
