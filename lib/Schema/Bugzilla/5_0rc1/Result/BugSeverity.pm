use utf8;
package Schema::Bugzilla::5_0rc1::Result::BugSeverity;
...
Schema::Bugzilla::5_0rc1::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UViKTu3GlJnAR19ePlSQxg
