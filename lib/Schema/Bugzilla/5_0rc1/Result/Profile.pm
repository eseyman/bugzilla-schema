use utf8;
package Schema::Bugzilla::5_0rc1::Result::Profile;
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::AuditLog>

=cut

__PACKAGE__->has_many(
  "audit_logs",
  "Schema::Bugzilla::5_0rc1::Result::AuditLog",
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::BugUserLastVisit>
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::ComponentCc>

=cut

__PACKAGE__->has_many(
  "component_ccs",
  "Schema::Bugzilla::5_0rc1::Result::ComponentCc",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Component>

=cut

__PACKAGE__->has_many(
  "components_initialowners",
  "Schema::Bugzilla::5_0rc1::Result::Component",
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::EmailBugIgnore>

=cut

__PACKAGE__->has_many(
  "email_bugs_ignore",
  "Schema::Bugzilla::5_0rc1::Result::EmailBugIgnore",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::EmailSetting>

=cut

__PACKAGE__->has_many(
  "email_settings",
  "Schema::Bugzilla::5_0rc1::Result::EmailSetting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Flag>

=cut

__PACKAGE__->has_many(
  "flags_requestees",
  "Schema::Bugzilla::5_0rc1::Result::Flag",
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::LoginFailure>

=cut

__PACKAGE__->has_many(
  "login_failures",
  "Schema::Bugzilla::5_0rc1::Result::LoginFailure",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Logincooky>

=cut

__PACKAGE__->has_many(
  "logincookies",
  "Schema::Bugzilla::5_0rc1::Result::Logincooky",
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::ProfileSearch>

=cut

__PACKAGE__->has_many(
  "profile_searches",
  "Schema::Bugzilla::5_0rc1::Result::ProfileSearch",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::ProfileSetting>

=cut

__PACKAGE__->has_many(
  "profile_settings",
  "Schema::Bugzilla::5_0rc1::Result::ProfileSetting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::ProfilesActivity>
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Quip>
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Report>
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Token>

=cut

__PACKAGE__->has_many(
  "tokens",
  "Schema::Bugzilla::5_0rc1::Result::Token",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::UserApiKey>

=cut

__PACKAGE__->has_many(
  "user_api_keys",
  "Schema::Bugzilla::5_0rc1::Result::UserApiKey",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::UserGroupMap>

=cut

__PACKAGE__->has_many(
  "user_group_maps",
  "Schema::Bugzilla::5_0rc1::Result::UserGroupMap",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::WhineEvent>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zI58PWHn9HttGJ4PITA6rw
