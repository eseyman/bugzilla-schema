use utf8;
package Schema::Bugzilla::5_0rc1::Result::bug_status;
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::status_workflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/fPD+zUMuEEtxrZIYhSWGg
