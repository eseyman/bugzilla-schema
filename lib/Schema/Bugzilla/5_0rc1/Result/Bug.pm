use utf8;
package Schema::Bugzilla::5_0rc1::Result::Bug;
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::BugGroupMap>

=cut

__PACKAGE__->has_many(
  "bug_group_maps",
  "Schema::Bugzilla::5_0rc1::Result::BugGroupMap",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::BugTag>

=cut

__PACKAGE__->has_many(
  "bug_tags",
  "Schema::Bugzilla::5_0rc1::Result::BugTag",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::BugsAlias>
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::BugSeeAlso>

=cut

__PACKAGE__->has_many(
  "bugs_see_also",
  "Schema::Bugzilla::5_0rc1::Result::BugSeeAlso",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Dependency>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::5_0rc1::Result::Dependency",
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Duplicate>
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Keyword>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::5_0rc1::Result::Keyword",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::Product>

=cut

__PACKAGE__->belongs_to(
  "product",
  "Schema::Bugzilla::5_0rc1::Result::Product",
  { id => "product_id" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MEAIEjjctK+b09gRXb8Rkw
