use utf8;
package Schema::Bugzilla::5_0rc1::Result::Attachment;
...
Related object: L<Schema::Bugzilla::5_0rc1::Result::AttachData>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EAXRwYywM7b3fNTeIGwpVw
