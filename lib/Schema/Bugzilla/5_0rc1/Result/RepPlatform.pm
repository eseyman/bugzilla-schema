use utf8;
package Schema::Bugzilla::5_0rc1::Result::RepPlatform;
...
Schema::Bugzilla::5_0rc1::Result::RepPlatform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bzUUIqU+2YCc9/20u1ogsA
