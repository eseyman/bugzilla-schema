use utf8;
package Schema::Bugzilla::5_0rc1::Result::rep_platform;
...
Schema::Bugzilla::5_0rc1::Result::rep_platform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qSVdfODFZdFFMfm1sshprg
