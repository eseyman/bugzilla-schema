use utf8;
package Schema::Bugzilla::3_5_3::Result::UserGroupMap;
...
Schema::Bugzilla::3_5_3::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:P5y3qD0iU5XrkE+VgqJTZw
