use utf8;
package Schema::Bugzilla::3_5_3::Result::bz_schema;
...
Schema::Bugzilla::3_5_3::Result::bz_schema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:9GA3+6iN+nwVCEw2GXvJ8A
