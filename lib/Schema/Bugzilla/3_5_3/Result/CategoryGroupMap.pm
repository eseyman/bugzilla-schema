use utf8;
package Schema::Bugzilla::3_5_3::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_5_3::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GAUOtMZJqokr+AOco/i8IA
