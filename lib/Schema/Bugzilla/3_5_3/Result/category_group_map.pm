use utf8;
package Schema::Bugzilla::3_5_3::Result::category_group_map;
...
Related object: L<Schema::Bugzilla::3_5_3::Result::series_categories>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AtdGYnTJZFBtDxhKzbsQLA
