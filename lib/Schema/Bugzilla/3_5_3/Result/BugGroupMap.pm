use utf8;
package Schema::Bugzilla::3_5_3::Result::BugGroupMap;
...
Schema::Bugzilla::3_5_3::Result::BugGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jnAwG9wCsKg3/IdMuNDiYw
