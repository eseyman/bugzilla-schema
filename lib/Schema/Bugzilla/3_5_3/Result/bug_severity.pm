use utf8;
package Schema::Bugzilla::3_5_3::Result::bug_severity;
...
Schema::Bugzilla::3_5_3::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GaQxBHzX4aeHn6M7WriFMA
