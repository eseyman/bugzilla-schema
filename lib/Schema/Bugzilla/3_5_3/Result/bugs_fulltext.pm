use utf8;
package Schema::Bugzilla::3_5_3::Result::bugs_fulltext;
...
Schema::Bugzilla::3_5_3::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:d+VivJVGtDSWvfaClTZddg
