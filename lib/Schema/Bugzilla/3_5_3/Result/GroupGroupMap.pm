use utf8;
package Schema::Bugzilla::3_5_3::Result::GroupGroupMap;
...
Schema::Bugzilla::3_5_3::Result::GroupGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:64JoECYurV4z8MaZqDdTtg
