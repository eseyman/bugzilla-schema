use utf8;
package Schema::Bugzilla::3_5_3::Result::ProfileSetting;
...
Schema::Bugzilla::3_5_3::Result::ProfileSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:A60Wf1zOG9grbPt+piufkw
