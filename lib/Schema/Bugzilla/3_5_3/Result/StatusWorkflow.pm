use utf8;
package Schema::Bugzilla::3_5_3::Result::StatusWorkflow;
...
Schema::Bugzilla::3_5_3::Result::StatusWorkflow
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hjYwm70SL2acUzR7lu9opw
