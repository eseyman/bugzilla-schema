use utf8;
package Schema::Bugzilla::3_5_3::Result::series;
...
Related object: L<Schema::Bugzilla::3_5_3::Result::series_data>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lPUzPpbD1ahNJn39rbodkw
