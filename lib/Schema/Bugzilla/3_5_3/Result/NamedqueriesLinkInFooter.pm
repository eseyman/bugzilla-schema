use utf8;
package Schema::Bugzilla::3_5_3::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::3_5_3::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DoD++g3VbMkPcR0zonHqjA
