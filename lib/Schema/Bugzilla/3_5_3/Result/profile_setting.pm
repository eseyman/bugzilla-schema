use utf8;
package Schema::Bugzilla::3_5_3::Result::profile_setting;
...
Related object: L<Schema::Bugzilla::3_5_3::Result::setting>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xdXuYt5B4A3SIIdLFfR8Ag
