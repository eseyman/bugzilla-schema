use utf8;
package Schema::Bugzilla::3_5_3::Result::series_categories;
...
Schema::Bugzilla::3_5_3::Result::series_categories
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XoZ+l+8Ix+zkkk5IE+WNNg
