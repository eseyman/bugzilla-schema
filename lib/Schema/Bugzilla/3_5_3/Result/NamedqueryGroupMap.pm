use utf8;
package Schema::Bugzilla::3_5_3::Result::NamedqueryGroupMap;
...
Schema::Bugzilla::3_5_3::Result::NamedqueryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+SWRI1XKuVIBIaboV+ThPQ
