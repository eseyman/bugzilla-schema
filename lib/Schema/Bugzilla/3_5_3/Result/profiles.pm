use utf8;
package Schema::Bugzilla::3_5_3::Result::profiles;
...
Related object: L<Schema::Bugzilla::3_5_3::Result::bugs_activity>
...
Related object: L<Schema::Bugzilla::3_5_3::Result::cc>

=cut

__PACKAGE__->has_many(
  "ccs",
  "Schema::Bugzilla::3_5_3::Result::cc",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::component_cc>

=cut

__PACKAGE__->has_many(
  "component_ccs",
  "Schema::Bugzilla::3_5_3::Result::component_cc",
...
Related object: L<Schema::Bugzilla::3_5_3::Result::components>

=cut

__PACKAGE__->has_many(
  "components_initialowners",
  "Schema::Bugzilla::3_5_3::Result::components",
...
Related object: L<Schema::Bugzilla::3_5_3::Result::email_setting>

=cut

__PACKAGE__->has_many(
  "email_settings",
  "Schema::Bugzilla::3_5_3::Result::email_setting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::flags>

=cut

__PACKAGE__->has_many(
  "flags_requestees",
  "Schema::Bugzilla::3_5_3::Result::flags",
...
Related object: L<Schema::Bugzilla::3_5_3::Result::login_failure>
...
Related object: L<Schema::Bugzilla::3_5_3::Result::logincookies>

=cut

__PACKAGE__->has_many(
  "logincookies",
  "Schema::Bugzilla::3_5_3::Result::logincookies",
...
Related object: L<Schema::Bugzilla::3_5_3::Result::longdescs>

=cut

__PACKAGE__->has_many(
  "longdescs",
  "Schema::Bugzilla::3_5_3::Result::longdescs",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::namedqueries_link_in_footer>

=cut

__PACKAGE__->has_many(
  "namedqueries_links_in_footer",
  "Schema::Bugzilla::3_5_3::Result::namedqueries_link_in_footer",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::profile_setting>

=cut

__PACKAGE__->has_many(
  "profile_settings",
  "Schema::Bugzilla::3_5_3::Result::profile_setting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::profiles_activity>

=cut

__PACKAGE__->has_many(
  "profiles_activities_who",
  "Schema::Bugzilla::3_5_3::Result::profiles_activity",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::quips>
...
Related object: L<Schema::Bugzilla::3_5_3::Result::tokens>

=cut

__PACKAGE__->has_many(
  "tokens",
  "Schema::Bugzilla::3_5_3::Result::tokens",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::user_group_map>
...
Related object: L<Schema::Bugzilla::3_5_3::Result::votes>

=cut

__PACKAGE__->has_many(
  "votes",
  "Schema::Bugzilla::3_5_3::Result::votes",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::watch>

=cut

__PACKAGE__->has_many(
  "watch_watchers",
  "Schema::Bugzilla::3_5_3::Result::watch",
...
Related object: L<Schema::Bugzilla::3_5_3::Result::whine_events>

=cut

__PACKAGE__->has_many(
  "whine_events",
  "Schema::Bugzilla::3_5_3::Result::whine_events",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:i5XCndPhS3DolFdq5NHrwg
