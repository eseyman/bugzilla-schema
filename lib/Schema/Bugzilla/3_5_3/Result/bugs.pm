use utf8;
package Schema::Bugzilla::3_5_3::Result::bugs;
...
Related object: L<Schema::Bugzilla::3_5_3::Result::bug_group_map>

=cut

__PACKAGE__->has_many(
  "bug_group_maps",
  "Schema::Bugzilla::3_5_3::Result::bug_group_map",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::3_5_3::Result::dependencies>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::3_5_3::Result::dependencies",
...
Related object: L<Schema::Bugzilla::3_5_3::Result::duplicates>

=cut

__PACKAGE__->might_have(
  "duplicates_dupe",
  "Schema::Bugzilla::3_5_3::Result::duplicates",
...
Related object: L<Schema::Bugzilla::3_5_3::Result::keywords>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::3_5_3::Result::keywords",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:I2/zOxiZTs/3pWlsTy3I2w
