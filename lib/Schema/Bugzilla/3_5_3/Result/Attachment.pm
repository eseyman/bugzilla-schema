use utf8;
package Schema::Bugzilla::3_5_3::Result::Attachment;
...
Schema::Bugzilla::3_5_3::Result::Attachment
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7QxC9lQSCz5D1jgpPoJaYQ
