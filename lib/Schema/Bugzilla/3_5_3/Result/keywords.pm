use utf8;
package Schema::Bugzilla::3_5_3::Result::keywords;
...
Related object: L<Schema::Bugzilla::3_5_3::Result::keyworddefs>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CcTC+/evnPVa/WBOLBvtDA
