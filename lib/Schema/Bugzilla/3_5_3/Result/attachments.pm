use utf8;
package Schema::Bugzilla::3_5_3::Result::attachments;
...
Related object: L<Schema::Bugzilla::3_5_3::Result::attach_data>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zOSkS4Z/tiqRGjgjxrJdOA
