use utf8;
package Schema::Bugzilla::4_2_1::Result::bug_severity;
...
Schema::Bugzilla::4_2_1::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MvTWEzWPVULlBpLNlhPPeg
