use utf8;
package Schema::Bugzilla::4_2_1::Result::Resolution;
...
Schema::Bugzilla::4_2_1::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+7BqjL2Y/fZvS2IQ7WXwQA
