use utf8;
package Schema::Bugzilla::4_2_1::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::4_2_1::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jj9K5as3NQpTJ3zr+xQYqg
