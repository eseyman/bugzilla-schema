use utf8;
package Schema::Bugzilla::4_2_1::Result::BugSeverity;
...
Schema::Bugzilla::4_2_1::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CXliFfgIvpfo77rAL2/4qw
