use utf8;
package Schema::Bugzilla::4_2_1::Result::ts_funcmap;
...
Schema::Bugzilla::4_2_1::Result::ts_funcmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C40CzLrwrFDuRwaXnzbdYg
