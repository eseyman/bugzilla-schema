use utf8;
package Schema::Bugzilla::4_2rc1::Result::Product;
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Classification>

=cut

__PACKAGE__->belongs_to(
  "classification",
  "Schema::Bugzilla::4_2rc1::Result::Classification",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Milestone>

=cut

__PACKAGE__->has_many(
  "milestones",
  "Schema::Bugzilla::4_2rc1::Result::Milestone",
  { "foreign.product_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Version>

=cut

__PACKAGE__->has_many(
  "versions",
  "Schema::Bugzilla::4_2rc1::Result::Version",
  { "foreign.product_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zlO5AsnnN9zFg/eZlaO1xg
