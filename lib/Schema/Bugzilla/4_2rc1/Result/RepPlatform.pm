use utf8;
package Schema::Bugzilla::4_2rc1::Result::RepPlatform;
...
Schema::Bugzilla::4_2rc1::Result::RepPlatform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PjugAA3+hGiY7C/A8Zs1kg
