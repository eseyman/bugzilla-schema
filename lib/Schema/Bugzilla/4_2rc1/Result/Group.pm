use utf8;
package Schema::Bugzilla::4_2rc1::Result::Group;
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::CategoryGroupMap>

=cut

__PACKAGE__->has_many(
  "category_group_maps",
  "Schema::Bugzilla::4_2rc1::Result::CategoryGroupMap",
  { "foreign.group_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Flagtype>

=cut

__PACKAGE__->has_many(
  "flagtypes_grant_groups",
  "Schema::Bugzilla::4_2rc1::Result::Flagtype",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::GroupControlMap>

=cut

__PACKAGE__->has_many(
  "group_control_maps",
  "Schema::Bugzilla::4_2rc1::Result::GroupControlMap",
  { "foreign.group_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::GroupGroupMap>

=cut

__PACKAGE__->has_many(
  "group_group_map_grantors",
  "Schema::Bugzilla::4_2rc1::Result::GroupGroupMap",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::NamedqueryGroupMap>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ulMnVr0Dh620LYrU9vuIfA
