use utf8;
package Schema::Bugzilla::4_2rc1::Result::ts_funcmap;
...
Schema::Bugzilla::4_2rc1::Result::ts_funcmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hma3qd1ExtNeZszD6Kx1Mg
