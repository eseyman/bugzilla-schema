use utf8;
package Schema::Bugzilla::4_2rc1::Result::BugsFulltext;
...
Schema::Bugzilla::4_2rc1::Result::BugsFulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5LzjI+zPMyqfXlIwmnGWdA
