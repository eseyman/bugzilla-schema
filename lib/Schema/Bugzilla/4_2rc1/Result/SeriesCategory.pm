use utf8;
package Schema::Bugzilla::4_2rc1::Result::SeriesCategory;
...
Schema::Bugzilla::4_2rc1::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LugwUt1hYoh+xH2hu+FFMw
