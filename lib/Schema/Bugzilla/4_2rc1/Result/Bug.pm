use utf8;
package Schema::Bugzilla::4_2rc1::Result::Bug;
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::BugGroupMap>
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::BugTag>

=cut

__PACKAGE__->has_many(
  "bug_tags",
  "Schema::Bugzilla::4_2rc1::Result::BugTag",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::BugSeeAlso>

=cut

__PACKAGE__->has_many(
  "bugs_see_also",
  "Schema::Bugzilla::4_2rc1::Result::BugSeeAlso",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Dependency>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::4_2rc1::Result::Dependency",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Duplicate>

=cut

__PACKAGE__->might_have(
  "duplicates_dupe",
  "Schema::Bugzilla::4_2rc1::Result::Duplicate",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Keyword>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::4_2rc1::Result::Keyword",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:M8cVICvynKdLdpoRnKSBXQ
