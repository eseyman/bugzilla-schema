use utf8;
package Schema::Bugzilla::4_2rc1::Result::bugs_fulltext;
...
Schema::Bugzilla::4_2rc1::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eRvFDZP8aQvf/iVbENTYnA
