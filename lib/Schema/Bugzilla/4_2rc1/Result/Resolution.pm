use utf8;
package Schema::Bugzilla::4_2rc1::Result::Resolution;
...
Schema::Bugzilla::4_2rc1::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Mugdl6HU4s6qWCJcs1wPrw
