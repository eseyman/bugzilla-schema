use utf8;
package Schema::Bugzilla::4_2rc1::Result::priority;
...
Schema::Bugzilla::4_2rc1::Result::priority
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MMHjo9Roo0IgMCmJdHB6VA
