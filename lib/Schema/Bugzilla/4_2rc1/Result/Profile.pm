use utf8;
package Schema::Bugzilla::4_2rc1::Result::Profile;
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Attachment>

=cut

__PACKAGE__->has_many(
  "attachments",
  "Schema::Bugzilla::4_2rc1::Result::Attachment",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::AuditLog>

=cut

__PACKAGE__->has_many(
  "audit_logs",
  "Schema::Bugzilla::4_2rc1::Result::AuditLog",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Component>
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::EmailSetting>

=cut

__PACKAGE__->has_many(
  "email_settings",
  "Schema::Bugzilla::4_2rc1::Result::EmailSetting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Flag>

=cut

__PACKAGE__->has_many(
  "flags_requestees",
  "Schema::Bugzilla::4_2rc1::Result::Flag",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::LoginFailure>

=cut

__PACKAGE__->has_many(
  "login_failures",
  "Schema::Bugzilla::4_2rc1::Result::LoginFailure",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Logincooky>

=cut

__PACKAGE__->has_many(
  "logincookies",
  "Schema::Bugzilla::4_2rc1::Result::Logincooky",
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Longdesc>

=cut

__PACKAGE__->has_many(
  "longdescs",
  "Schema::Bugzilla::4_2rc1::Result::Longdesc",
  { "foreign.who" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::NamedqueriesLinkInFooter>

=cut

__PACKAGE__->has_many(
  "namedqueries_links_in_footer",
  "Schema::Bugzilla::4_2rc1::Result::NamedqueriesLinkInFooter",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::ProfileSetting>

=cut

__PACKAGE__->has_many(
  "profile_settings",
  "Schema::Bugzilla::4_2rc1::Result::ProfileSetting",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Quip>

=cut

__PACKAGE__->has_many(
  "quips",
  "Schema::Bugzilla::4_2rc1::Result::Quip",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::Token>

=cut

__PACKAGE__->has_many(
  "tokens",
  "Schema::Bugzilla::4_2rc1::Result::Token",
  { "foreign.userid" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::UserGroupMap>

=cut

__PACKAGE__->has_many(
  "user_group_maps",
  "Schema::Bugzilla::4_2rc1::Result::UserGroupMap",
  { "foreign.user_id" => "self.userid" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::WhineEvent>

=cut

__PACKAGE__->has_many(
  "whine_events",
  "Schema::Bugzilla::4_2rc1::Result::WhineEvent",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dNdYovjEW60TZVZAzfbpRw
