use utf8;
package Schema::Bugzilla::4_2rc1::Result::profile_setting;
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::setting>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hi9ALkVjeh92dYT6BalBig
