use utf8;
package Schema::Bugzilla::4_2rc1::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::4_2rc1::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5ToS9yjfDkFmI3FcAtj8wA
