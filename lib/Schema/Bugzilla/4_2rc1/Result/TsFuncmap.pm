use utf8;
package Schema::Bugzilla::4_2rc1::Result::TsFuncmap;
...
Schema::Bugzilla::4_2rc1::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:B76fMttVhqOz7JqJ/GyopA
