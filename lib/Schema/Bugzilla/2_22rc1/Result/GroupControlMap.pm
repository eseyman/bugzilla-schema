use utf8;
package Schema::Bugzilla::2_22rc1::Result::GroupControlMap;
...
Schema::Bugzilla::2_22rc1::Result::GroupControlMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tzMkVOT8Ix+Adg1UNRuIDQ
