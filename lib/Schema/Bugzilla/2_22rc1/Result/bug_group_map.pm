use utf8;
package Schema::Bugzilla::2_22rc1::Result::bug_group_map;
...
Schema::Bugzilla::2_22rc1::Result::bug_group_map
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:h0MhuIvjS17EtbAYdaqzDQ
