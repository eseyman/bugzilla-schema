use utf8;
package Schema::Bugzilla::2_22rc1::Result::components;
...
Schema::Bugzilla::2_22rc1::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pVUdSuTJHjoVUqs6ZvcI5A
