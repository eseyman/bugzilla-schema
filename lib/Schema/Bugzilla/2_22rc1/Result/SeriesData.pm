use utf8;
package Schema::Bugzilla::2_22rc1::Result::SeriesData;
...
Schema::Bugzilla::2_22rc1::Result::SeriesData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:T7XOxEZgILRwbLv3TrEOfg
