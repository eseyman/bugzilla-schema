use utf8;
package Schema::Bugzilla::2_22rc1::Result::bug_severity;
...
Schema::Bugzilla::2_22rc1::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NgaUjB3f3so2GhBtvqq2JQ
