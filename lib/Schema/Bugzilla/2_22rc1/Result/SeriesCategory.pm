use utf8;
package Schema::Bugzilla::2_22rc1::Result::SeriesCategory;
...
Schema::Bugzilla::2_22rc1::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:P+ERpQXE9m0s/UrLD0lmig
