use utf8;
package Schema::Bugzilla::2_22rc1::Result::GroupGroupMap;
...
Schema::Bugzilla::2_22rc1::Result::GroupGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:M9tpgSg6TfszAySKuZcfcw
