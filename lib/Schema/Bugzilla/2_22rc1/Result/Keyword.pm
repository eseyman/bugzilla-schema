use utf8;
package Schema::Bugzilla::2_22rc1::Result::Keyword;
...
Schema::Bugzilla::2_22rc1::Result::Keyword
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NnRztzcBC4PVItmVQyAIfQ
