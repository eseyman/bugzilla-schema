use utf8;
package Schema::Bugzilla::4_1_3::Result::Keyword;
...
Related object: L<Schema::Bugzilla::4_1_3::Result::Keyworddef>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XSQ3sGvY1NUNFvPOOmB1uA
