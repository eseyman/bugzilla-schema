use utf8;
package Schema::Bugzilla::4_1_3::Result::Resolution;
...
Schema::Bugzilla::4_1_3::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iY6XpQHMZNRcp5dzw+lguA
