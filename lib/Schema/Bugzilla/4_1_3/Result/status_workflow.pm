use utf8;
package Schema::Bugzilla::4_1_3::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::4_1_3::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lO6XI8cmlCxRbsvuWX1Ygw
