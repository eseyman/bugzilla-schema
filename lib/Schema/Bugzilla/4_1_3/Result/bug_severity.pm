use utf8;
package Schema::Bugzilla::4_1_3::Result::bug_severity;
...
Schema::Bugzilla::4_1_3::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QQ0+h6w9syVsolaakj8fxw
