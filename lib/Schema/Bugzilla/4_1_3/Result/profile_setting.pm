use utf8;
package Schema::Bugzilla::4_1_3::Result::profile_setting;
...
Related object: L<Schema::Bugzilla::4_1_3::Result::setting>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KGLgWdNwHlEVeZRBe59ZnA
