use utf8;
package Schema::Bugzilla::4_0::Result::StatusWorkflow;
...
Schema::Bugzilla::4_0::Result::StatusWorkflow
...
Related object: L<Schema::Bugzilla::4_0::Result::BugStatus>

=cut

__PACKAGE__->belongs_to(
  "new_status",
  "Schema::Bugzilla::4_0::Result::BugStatus",
  { id => "new_status" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TM/cXMU8wx6DhQCTxzJvjA
