use utf8;
package Schema::Bugzilla::4_0::Result::TsExitstatus;
...
Schema::Bugzilla::4_0::Result::TsExitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nmw7dfIhEY9Heqw4ODtJNQ
