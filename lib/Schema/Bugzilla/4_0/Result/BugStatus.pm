use utf8;
package Schema::Bugzilla::4_0::Result::BugStatus;
...
Related object: L<Schema::Bugzilla::4_0::Result::StatusWorkflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yuSxBN5DVqJPgXQs5l1Buw
