use utf8;
package Schema::Bugzilla::4_0::Result::bug_severity;
...
Schema::Bugzilla::4_0::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Rx45SOx/qtU+GB6PQaA2ug
