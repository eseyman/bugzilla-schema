use utf8;
package Schema::Bugzilla::4_0::Result::keyworddefs;
...
Schema::Bugzilla::4_0::Result::keyworddefs
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jqZT1oihrkpXwUobJzRsjg
