use utf8;
package Schema::Bugzilla::4_0::Result::series_categories;
...
Schema::Bugzilla::4_0::Result::series_categories
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vs30ng7BVJc8eB9An1SOWw
