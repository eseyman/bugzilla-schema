use utf8;
package Schema::Bugzilla::4_0::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::4_0::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MLnZeW9bddZHYezAOjQ8Lg
