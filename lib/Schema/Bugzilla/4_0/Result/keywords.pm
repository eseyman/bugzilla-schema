use utf8;
package Schema::Bugzilla::4_0::Result::keywords;
...
Related object: L<Schema::Bugzilla::4_0::Result::keyworddefs>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zQIaUcEjhdm3Ehl+YyFxvg
