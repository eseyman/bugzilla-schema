use utf8;
package Schema::Bugzilla::4_0::Result::BugSeverity;
...
Schema::Bugzilla::4_0::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5h5ZdXRcHtJf8sIy4SFONw
