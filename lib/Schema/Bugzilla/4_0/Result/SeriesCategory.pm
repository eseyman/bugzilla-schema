use utf8;
package Schema::Bugzilla::4_0::Result::SeriesCategory;
...
Schema::Bugzilla::4_0::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Fm7e7yia4t6DbU3x3MscPg
