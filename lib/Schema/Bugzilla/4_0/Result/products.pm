use utf8;
package Schema::Bugzilla::4_0::Result::products;
...
Related object: L<Schema::Bugzilla::4_0::Result::classifications>

=cut

__PACKAGE__->belongs_to(
  "classification",
  "Schema::Bugzilla::4_0::Result::classifications",
...
Related object: L<Schema::Bugzilla::4_0::Result::milestones>

=cut

__PACKAGE__->has_many(
  "milestones",
  "Schema::Bugzilla::4_0::Result::milestones",
  { "foreign.product_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_0::Result::versions>

=cut

__PACKAGE__->has_many(
  "versions",
  "Schema::Bugzilla::4_0::Result::versions",
  { "foreign.product_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0KmepC+5Uup6Y3udqn9jtQ
