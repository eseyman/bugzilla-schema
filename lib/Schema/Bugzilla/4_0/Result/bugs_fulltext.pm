use utf8;
package Schema::Bugzilla::4_0::Result::bugs_fulltext;
...
Schema::Bugzilla::4_0::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:9jalC4wBd0Vuqbh7yvKpHA
