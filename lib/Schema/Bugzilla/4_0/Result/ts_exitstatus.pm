use utf8;
package Schema::Bugzilla::4_0::Result::ts_exitstatus;
...
Schema::Bugzilla::4_0::Result::ts_exitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WTsReToMrfuHuTojr2a9XQ
