use utf8;
package Schema::Bugzilla::4_2rc2::Result::SettingValue;
...
Related object: L<Schema::Bugzilla::4_2rc2::Result::Setting>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+uqoqHGZkRae+vFhlwQRsQ
