use utf8;
package Schema::Bugzilla::4_2rc2::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::4_2rc2::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lKZNt4P1zJHA6MQVnPosJQ
