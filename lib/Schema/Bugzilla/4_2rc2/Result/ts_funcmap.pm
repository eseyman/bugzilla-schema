use utf8;
package Schema::Bugzilla::4_2rc2::Result::ts_funcmap;
...
Schema::Bugzilla::4_2rc2::Result::ts_funcmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:z4qevVmjVhJtmqKDPeuZpw
