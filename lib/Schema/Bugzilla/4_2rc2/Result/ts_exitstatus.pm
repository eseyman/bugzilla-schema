use utf8;
package Schema::Bugzilla::4_2rc2::Result::ts_exitstatus;
...
Schema::Bugzilla::4_2rc2::Result::ts_exitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bD4IVub5nzjbRH0dOZZ3bw
