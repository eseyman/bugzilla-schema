use utf8;
package Schema::Bugzilla::4_2rc2::Result::keywords;
...
Related object: L<Schema::Bugzilla::4_2rc2::Result::keyworddefs>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UybvqzMo4H6oa3AvJmnEEg
