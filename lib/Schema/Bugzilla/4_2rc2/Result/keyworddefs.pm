use utf8;
package Schema::Bugzilla::4_2rc2::Result::keyworddefs;
...
Schema::Bugzilla::4_2rc2::Result::keyworddefs
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:caQYMZoeD9EIe06jSIIUWw
