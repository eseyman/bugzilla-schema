use utf8;
package Schema::Bugzilla::4_2rc2::Result::series_categories;
...
Schema::Bugzilla::4_2rc2::Result::series_categories
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6e36cGflXfKHOOEApCksrQ
