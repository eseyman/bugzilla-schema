use utf8;
package Schema::Bugzilla::4_2rc2::Result::bugs_fulltext;
...
Schema::Bugzilla::4_2rc2::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oqbuvypZVwHtc9DHTZmxpQ
