use utf8;
package Schema::Bugzilla::4_2rc2::Result::Priority;
...
Schema::Bugzilla::4_2rc2::Result::Priority
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:b/5o4DRJnbcNtXntiIDs0A
