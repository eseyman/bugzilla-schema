use utf8;
package Schema::Bugzilla::2_20rc1::Result::RepPlatform;
...
Schema::Bugzilla::2_20rc1::Result::RepPlatform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IMLrgJkmPCXaP5/6aMWAlw
