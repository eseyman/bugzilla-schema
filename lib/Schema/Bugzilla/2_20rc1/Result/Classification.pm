use utf8;
package Schema::Bugzilla::2_20rc1::Result::Classification;
...
Schema::Bugzilla::2_20rc1::Result::Classification
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vgnnPwCK8ZsMFgjx1n1x3A
