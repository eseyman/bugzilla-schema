use utf8;
package Schema::Bugzilla::2_20rc1::Result::flagtypes;
...
Schema::Bugzilla::2_20rc1::Result::flagtypes
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aZ/ipW/EmLUzFt6amoQNAg
