use utf8;
package Schema::Bugzilla::2_20rc1::Result::Flagtype;
...
Schema::Bugzilla::2_20rc1::Result::Flagtype
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tlgCOROrxc8pbi2PMJ+t6Q
