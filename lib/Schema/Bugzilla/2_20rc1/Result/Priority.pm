use utf8;
package Schema::Bugzilla::2_20rc1::Result::Priority;
...
Schema::Bugzilla::2_20rc1::Result::Priority
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qyKDOx9U+SZeEBFJrJmlfA
