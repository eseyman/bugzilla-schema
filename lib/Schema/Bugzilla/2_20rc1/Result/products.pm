use utf8;
package Schema::Bugzilla::2_20rc1::Result::products;
...
Schema::Bugzilla::2_20rc1::Result::products
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SC4+mFJvBEe7dSJazp97cA
