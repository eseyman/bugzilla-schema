use utf8;
package Schema::Bugzilla::2_20rc1::Result::versions;
...
Schema::Bugzilla::2_20rc1::Result::versions
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KMl1UERPtVI2PuYD2NL60Q
