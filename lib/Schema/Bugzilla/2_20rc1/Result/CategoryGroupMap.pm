use utf8;
package Schema::Bugzilla::2_20rc1::Result::CategoryGroupMap;
...
Schema::Bugzilla::2_20rc1::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GbP/sYw+EgoMWNOrSIIQ2w
