use utf8;
package Schema::Bugzilla::2_20rc1::Result::series_categories;
...
Schema::Bugzilla::2_20rc1::Result::series_categories
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Hc+BJC7CBjdvEjTyDxEgrQ
