use utf8;
package Schema::Bugzilla::2_20rc1::Result::components;
...
Schema::Bugzilla::2_20rc1::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YzJ9geDmZ3Jv20JiKfZoNg
