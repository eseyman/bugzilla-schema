use utf8;
package Schema::Bugzilla::2_20rc1::Result::email_setting;
...
Schema::Bugzilla::2_20rc1::Result::email_setting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gQLJnzIi/dM2/xJR8DI+jw
