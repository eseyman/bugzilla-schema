use utf8;
package Schema::Bugzilla::2_20rc1::Result::Product;
...
Schema::Bugzilla::2_20rc1::Result::Product
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BlqI8cNnZJhkQBeulHr8Qw
