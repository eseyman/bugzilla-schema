use utf8;
package Schema::Bugzilla::2_20rc1::Result::classifications;
...
Schema::Bugzilla::2_20rc1::Result::classifications
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SxAgFk5PDVwZv+l9dnHCqw
