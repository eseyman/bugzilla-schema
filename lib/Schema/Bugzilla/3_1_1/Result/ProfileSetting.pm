use utf8;
package Schema::Bugzilla::3_1_1::Result::ProfileSetting;
...
Schema::Bugzilla::3_1_1::Result::ProfileSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UJk19C+mFZZ9+NySPvFydQ
