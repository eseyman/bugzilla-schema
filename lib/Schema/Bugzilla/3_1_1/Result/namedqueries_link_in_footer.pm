use utf8;
package Schema::Bugzilla::3_1_1::Result::namedqueries_link_in_footer;
...
Schema::Bugzilla::3_1_1::Result::namedqueries_link_in_footer
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:24eSLHJZqQfkt3sa01AsTw
