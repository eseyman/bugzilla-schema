use utf8;
package Schema::Bugzilla::3_1_1::Result::BugStatus;
...
Schema::Bugzilla::3_1_1::Result::BugStatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ySkRk5xebC/qB7sRBqV5iw
