use utf8;
package Schema::Bugzilla::3_1_1::Result::BugSeverity;
...
Schema::Bugzilla::3_1_1::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Pw3XOTMqlqnSZxGJ/L/YdQ
