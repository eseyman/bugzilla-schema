use utf8;
package Schema::Bugzilla::3_1_1::Result::flagtypes;
...
Schema::Bugzilla::3_1_1::Result::flagtypes
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xHYcm15LTEXjAnYKJE3prg
