use utf8;
package Schema::Bugzilla::3_1_1::Result::series_categories;
...
Schema::Bugzilla::3_1_1::Result::series_categories
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Tg44PrRlS1yiy+gJ7yBfVQ
