use utf8;
package Schema::Bugzilla::3_1_1::Result::email_setting;
...
Schema::Bugzilla::3_1_1::Result::email_setting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xuQNpteHBuOqf+aHWEKRew
