use utf8;
package Schema::Bugzilla::3_1_1::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::3_1_1::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DXZWvHFbld0vfykPLQAZXA
