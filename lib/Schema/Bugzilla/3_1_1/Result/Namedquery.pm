use utf8;
package Schema::Bugzilla::3_1_1::Result::Namedquery;
...
Schema::Bugzilla::3_1_1::Result::Namedquery
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+cC7f7WdLsJgCuHNLka6Xg
