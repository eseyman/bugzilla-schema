use utf8;
package Schema::Bugzilla::3_1_1::Result::Resolution;
...
Schema::Bugzilla::3_1_1::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VNYK87sQAMMLXx/d6/qekA
