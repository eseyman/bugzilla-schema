use utf8;
package Schema::Bugzilla::3_1_1::Result::StatusWorkflow;
...
Schema::Bugzilla::3_1_1::Result::StatusWorkflow
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WyBZiNKaMTIKKnpewKWB8Q
