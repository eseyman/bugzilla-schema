use utf8;
package Schema::Bugzilla::3_1_1::Result::namedquery_group_map;
...
Schema::Bugzilla::3_1_1::Result::namedquery_group_map
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FK8vMx1SYpIwFRVFWLsUkQ
