use utf8;
package Schema::Bugzilla::3_1_1::Result::Attachment;
...
Schema::Bugzilla::3_1_1::Result::Attachment
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lOemImo6GPXs0Ns1D2TcXw
