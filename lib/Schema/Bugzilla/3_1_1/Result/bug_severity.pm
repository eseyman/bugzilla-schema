use utf8;
package Schema::Bugzilla::3_1_1::Result::bug_severity;
...
Schema::Bugzilla::3_1_1::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+y6fPxBOGFqJCDGpIlRywg
