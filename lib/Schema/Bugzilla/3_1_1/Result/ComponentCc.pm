use utf8;
package Schema::Bugzilla::3_1_1::Result::ComponentCc;
...
Schema::Bugzilla::3_1_1::Result::ComponentCc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oVmFw/6TBXOPZENMbO8liA
