use utf8;
package Schema::Bugzilla::3_1_1::Result::components;
...
Schema::Bugzilla::3_1_1::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ttCz2kVXeX3OtU4tPmrE+w
