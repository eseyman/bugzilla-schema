use utf8;
package Schema::Bugzilla::3_1_1::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_1_1::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4EUKZA9nRtkLzL2NqjehjQ
