use utf8;
package Schema::Bugzilla::3_1_1::Result::attachments;
...
Schema::Bugzilla::3_1_1::Result::attachments
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KvGBYKHX5Vc1+iYktTZyHA
