use utf8;
package Schema::Bugzilla::3_1_1::Result::bug_status;
...
Schema::Bugzilla::3_1_1::Result::bug_status
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vqGTnrUAc1XNH0zrIGnStg
