use utf8;
package Schema::Bugzilla::4_5_1::Result::BugSeverity;
...
Schema::Bugzilla::4_5_1::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tQ7tVcabNI4CTogxA2loQA
