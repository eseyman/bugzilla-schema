use utf8;
package Schema::Bugzilla::4_5_1::Result::Group;
...
Related object: L<Schema::Bugzilla::4_5_1::Result::CategoryGroupMap>

=cut

__PACKAGE__->has_many(
  "category_group_maps",
  "Schema::Bugzilla::4_5_1::Result::CategoryGroupMap",
  { "foreign.group_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_5_1::Result::GroupGroupMap>

=cut

__PACKAGE__->has_many(
  "group_group_map_grantors",
  "Schema::Bugzilla::4_5_1::Result::GroupGroupMap",
...
Related object: L<Schema::Bugzilla::4_5_1::Result::NamedqueryGroupMap>

=cut

__PACKAGE__->has_many(
  "namedquery_group_maps",
  "Schema::Bugzilla::4_5_1::Result::NamedqueryGroupMap",
  { "foreign.group_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:K3D6xBHtpYV4KHcfclcuTQ
