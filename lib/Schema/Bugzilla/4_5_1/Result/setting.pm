...
Related object: L<Schema::Bugzilla::4_5_1::Result::setting_value>

=cut

__PACKAGE__->has_many(
  "setting_values",
  "Schema::Bugzilla::4_5_1::Result::setting_value",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uAlmH7iIfCJDuLqTPFP1qg
