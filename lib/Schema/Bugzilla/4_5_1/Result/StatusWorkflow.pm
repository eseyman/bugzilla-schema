use utf8;
package Schema::Bugzilla::4_5_1::Result::StatusWorkflow;
...
Related object: L<Schema::Bugzilla::4_5_1::Result::BugStatus>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:wh25xY3EDo6A+VtqFHdDcg
