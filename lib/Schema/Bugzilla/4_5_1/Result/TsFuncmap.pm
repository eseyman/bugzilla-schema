use utf8;
package Schema::Bugzilla::4_5_1::Result::TsFuncmap;
...
Schema::Bugzilla::4_5_1::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NCUGpZbJd0XxW8KlKkYPaQ
