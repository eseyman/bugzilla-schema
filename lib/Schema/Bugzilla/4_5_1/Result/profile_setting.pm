use utf8;
package Schema::Bugzilla::4_5_1::Result::profile_setting;
...
Related object: L<Schema::Bugzilla::4_5_1::Result::setting>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:88if2QTG5U4aMrEjdVO0+w
