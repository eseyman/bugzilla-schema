use utf8;
package Schema::Bugzilla::4_5_1::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::4_5_1::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YURpTdo9D6oA3dRxqfxtAw
