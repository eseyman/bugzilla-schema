use utf8;
package Schema::Bugzilla::4_5_1::Result::Keyword;
...
Related object: L<Schema::Bugzilla::4_5_1::Result::Keyworddef>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rhldquXXDX9D4nSX6an1dg
