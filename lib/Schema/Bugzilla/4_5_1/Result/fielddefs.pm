use utf8;
package Schema::Bugzilla::4_5_1::Result::fielddefs;
...
Related object: L<Schema::Bugzilla::4_5_1::Result::field_visibility>

=cut

__PACKAGE__->has_many(
  "field_visibilities",
  "Schema::Bugzilla::4_5_1::Result::field_visibility",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qIUd2+Kg2LjVWQjIWScvsg
