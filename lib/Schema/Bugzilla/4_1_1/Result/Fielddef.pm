use utf8;
package Schema::Bugzilla::4_1_1::Result::Fielddef;
...
Related object: L<Schema::Bugzilla::4_1_1::Result::FieldVisibility>

=cut

__PACKAGE__->has_many(
  "field_visibilities",
  "Schema::Bugzilla::4_1_1::Result::FieldVisibility",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Khdj4JBR6jXXgDiAmKyfwQ
