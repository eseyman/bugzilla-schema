use utf8;
package Schema::Bugzilla::4_1_1::Result::Keyword;
...
Related object: L<Schema::Bugzilla::4_1_1::Result::Keyworddef>

=cut

__PACKAGE__->belongs_to(
  "keywordid",
  "Schema::Bugzilla::4_1_1::Result::Keyworddef",
  { id => "keywordid" },
  { is_deferrable => 1, on_delete => "CASCADE", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sxwA2A+5tYCCiE15EOW0AQ
