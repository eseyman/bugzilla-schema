use utf8;
package Schema::Bugzilla::4_1_1::Result::fielddefs;
...
Related object: L<Schema::Bugzilla::4_1_1::Result::field_visibility>

=cut

__PACKAGE__->has_many(
  "field_visibilities",
  "Schema::Bugzilla::4_1_1::Result::field_visibility",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MSL9nhV3vk6bHLal5pQtMg
