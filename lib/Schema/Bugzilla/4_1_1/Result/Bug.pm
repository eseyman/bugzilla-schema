use utf8;
package Schema::Bugzilla::4_1_1::Result::Bug;
...
Related object: L<Schema::Bugzilla::4_1_1::Result::BugGroupMap>

=cut

__PACKAGE__->has_many(
  "bug_group_maps",
  "Schema::Bugzilla::4_1_1::Result::BugGroupMap",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_1_1::Result::BugTag>
...
Related object: L<Schema::Bugzilla::4_1_1::Result::BugSeeAlso>

=cut

__PACKAGE__->has_many(
  "bugs_see_also",
  "Schema::Bugzilla::4_1_1::Result::BugSeeAlso",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_1_1::Result::Dependency>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::4_1_1::Result::Dependency",
...
Related object: L<Schema::Bugzilla::4_1_1::Result::Duplicate>

=cut

__PACKAGE__->might_have(
  "duplicates_dupe",
  "Schema::Bugzilla::4_1_1::Result::Duplicate",
...
Related object: L<Schema::Bugzilla::4_1_1::Result::Keyword>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::4_1_1::Result::Keyword",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:THedYmfVRS3XLEKJ7JY4dA
