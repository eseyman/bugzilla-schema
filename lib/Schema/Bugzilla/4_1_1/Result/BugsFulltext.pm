use utf8;
package Schema::Bugzilla::4_1_1::Result::BugsFulltext;
...
Schema::Bugzilla::4_1_1::Result::BugsFulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:88vyyjqunJtAIXtmHgKGCw
