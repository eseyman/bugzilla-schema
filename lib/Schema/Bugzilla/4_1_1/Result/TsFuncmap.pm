use utf8;
package Schema::Bugzilla::4_1_1::Result::TsFuncmap;
...
Schema::Bugzilla::4_1_1::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GbgCA0ky83rOAbRT9Exigw
