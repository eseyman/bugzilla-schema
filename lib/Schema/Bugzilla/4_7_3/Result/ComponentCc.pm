use utf8;
package Schema::Bugzilla::4_7_3::Result::ComponentCc;
...
Schema::Bugzilla::4_7_3::Result::ComponentCc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cmTumYnIKW5ZpaHM8Y96FA
