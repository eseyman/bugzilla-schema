use utf8;
package Schema::Bugzilla::4_7_3::Result::SettingValue;
...
Schema::Bugzilla::4_7_3::Result::SettingValue
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5hEBI9Ro+H97z/TkrMusMw
