use utf8;
package Schema::Bugzilla::4_7_3::Result::GroupGroupMap;
...
Schema::Bugzilla::4_7_3::Result::GroupGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SmsKO/I4LjtwygFQNkJcow
