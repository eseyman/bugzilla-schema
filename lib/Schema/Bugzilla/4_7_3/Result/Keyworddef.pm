use utf8;
package Schema::Bugzilla::4_7_3::Result::Keyworddef;
...
Schema::Bugzilla::4_7_3::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0ak63BtcbT6WdecoBXQbow
