use utf8;
package Schema::Bugzilla::4_7_3::Result::UserGroupMap;
...
Schema::Bugzilla::4_7_3::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gnInF2Abx9tHCF13XMoXUQ
