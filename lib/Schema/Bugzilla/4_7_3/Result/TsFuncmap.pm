use utf8;
package Schema::Bugzilla::4_7_3::Result::TsFuncmap;
...
Schema::Bugzilla::4_7_3::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XXJ79HdRLvuAFw0blSqYxg
