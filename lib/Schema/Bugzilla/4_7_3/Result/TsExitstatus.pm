use utf8;
package Schema::Bugzilla::4_7_3::Result::TsExitstatus;
...
Schema::Bugzilla::4_7_3::Result::TsExitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:A6Q6oAAxbhP4Rc8x+oZUvg
