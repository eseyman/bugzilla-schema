use utf8;
package Schema::Bugzilla::4_7_3::Result::Attachment;
...
Schema::Bugzilla::4_7_3::Result::Attachment
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HBheRPUHaIvJ1P+8xSZFLA
