use utf8;
package Schema::Bugzilla::4_7_3::Result::ProfileSetting;
...
Schema::Bugzilla::4_7_3::Result::ProfileSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8aXjo2sh1r4JHoqonYHZ7w
