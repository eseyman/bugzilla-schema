use utf8;
package Schema::Bugzilla::4_7_3::Result::BugStatus;
...
Schema::Bugzilla::4_7_3::Result::BugStatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TNA+YiPkz948WDRO/61aTw
