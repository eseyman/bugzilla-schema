use utf8;
package Schema::Bugzilla::4_7_3::Result::Resolution;
...
Schema::Bugzilla::4_7_3::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:X96Ua0KV5FeghcEpaU5UZw
