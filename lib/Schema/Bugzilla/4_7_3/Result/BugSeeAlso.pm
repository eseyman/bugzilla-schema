use utf8;
package Schema::Bugzilla::4_7_3::Result::BugSeeAlso;
...
Schema::Bugzilla::4_7_3::Result::BugSeeAlso
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4TSeJJyx2D+ik2Mwjo5QRQ
