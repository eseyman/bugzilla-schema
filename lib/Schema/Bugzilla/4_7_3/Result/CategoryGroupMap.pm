use utf8;
package Schema::Bugzilla::4_7_3::Result::CategoryGroupMap;
...
Schema::Bugzilla::4_7_3::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4tTrH8HHxdwwNLY8LATLSg
