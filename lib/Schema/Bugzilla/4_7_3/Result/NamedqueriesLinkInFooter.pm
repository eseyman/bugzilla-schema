use utf8;
package Schema::Bugzilla::4_7_3::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::4_7_3::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VGtkfNC70iOzunwk4dqiVw
