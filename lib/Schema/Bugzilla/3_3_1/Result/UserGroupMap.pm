use utf8;
package Schema::Bugzilla::3_3_1::Result::UserGroupMap;
...
Schema::Bugzilla::3_3_1::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zOlRjQW7bYVp/lbqFQ4FXA
