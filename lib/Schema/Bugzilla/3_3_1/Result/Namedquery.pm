use utf8;
package Schema::Bugzilla::3_3_1::Result::Namedquery;
...
Schema::Bugzilla::3_3_1::Result::Namedquery
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zFRrt4z9YAG8+KwXmYDXaA
