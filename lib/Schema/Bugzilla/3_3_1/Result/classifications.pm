use utf8;
package Schema::Bugzilla::3_3_1::Result::classifications;
...
Schema::Bugzilla::3_3_1::Result::classifications
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AD4UGDbEs7cbpfe2NmSPtQ
