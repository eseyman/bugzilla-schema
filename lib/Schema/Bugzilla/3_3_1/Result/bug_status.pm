use utf8;
package Schema::Bugzilla::3_3_1::Result::bug_status;
...
Schema::Bugzilla::3_3_1::Result::bug_status
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/EU+ps6QWGmOZG1VsqO5FQ
