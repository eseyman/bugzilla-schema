use utf8;
package Schema::Bugzilla::3_3_1::Result::Keyworddef;
...
Schema::Bugzilla::3_3_1::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lJ25rRQXg6rHTBwR2dPIeg
