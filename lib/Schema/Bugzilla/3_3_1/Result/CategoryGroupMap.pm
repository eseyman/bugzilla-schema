use utf8;
package Schema::Bugzilla::3_3_1::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_3_1::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dvjBMFazZsbVD72AFAbdKA
