use utf8;
package Schema::Bugzilla::3_3_1::Result::keywords;
...
Related object: L<Schema::Bugzilla::3_3_1::Result::keyworddefs>

=cut

__PACKAGE__->belongs_to(
  "keywordid",
  "Schema::Bugzilla::3_3_1::Result::keyworddefs",
  { id => "keywordid" },
  { is_deferrable => 1, on_delete => "CASCADE", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tt4uI2XIP+g5vQDYftR9FA
