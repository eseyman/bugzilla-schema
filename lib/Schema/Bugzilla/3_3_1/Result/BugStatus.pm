use utf8;
package Schema::Bugzilla::3_3_1::Result::BugStatus;
...
Schema::Bugzilla::3_3_1::Result::BugStatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ysvON+eneENDAVG6+lQxNA
