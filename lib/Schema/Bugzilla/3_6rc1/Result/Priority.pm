use utf8;
package Schema::Bugzilla::3_6rc1::Result::Priority;
...
Schema::Bugzilla::3_6rc1::Result::Priority
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2+EvmODGLNDZtLCWKl3Nkw
