use utf8;
package Schema::Bugzilla::3_6rc1::Result::SeriesData;
...
Schema::Bugzilla::3_6rc1::Result::SeriesData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VT++AayVQvh0SbvkAcxaCA
