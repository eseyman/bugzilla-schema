use utf8;
package Schema::Bugzilla::3_6rc1::Result::SeriesCategory;
...
Schema::Bugzilla::3_6rc1::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Zlrt2KUtN/qbKmw+iNdxEw
