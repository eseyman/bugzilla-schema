use utf8;
package Schema::Bugzilla::3_6rc1::Result::BugsFulltext;
...
Schema::Bugzilla::3_6rc1::Result::BugsFulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2k0DTbkI3+KonG427IutIQ
