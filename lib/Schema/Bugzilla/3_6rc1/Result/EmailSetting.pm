use utf8;
package Schema::Bugzilla::3_6rc1::Result::EmailSetting;
...
Schema::Bugzilla::3_6rc1::Result::EmailSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BwYEIVE+bYgIW396kKE1qw
