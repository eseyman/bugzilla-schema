use utf8;
package Schema::Bugzilla::3_6rc1::Result::Milestone;
...
Schema::Bugzilla::3_6rc1::Result::Milestone
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:x9s18aHyTHzV2CcFnZNQ5w
