use utf8;
package Schema::Bugzilla::3_6rc1::Result::UserGroupMap;
...
Schema::Bugzilla::3_6rc1::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4cnuvhmPd+k1o8zSqlWIMA
