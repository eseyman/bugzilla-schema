use utf8;
package Schema::Bugzilla::3_6rc1::Result::Flagtype;
...
Schema::Bugzilla::3_6rc1::Result::Flagtype
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3TO14uwlcikAeyZFi4p3uQ
