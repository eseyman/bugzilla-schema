use utf8;
package Schema::Bugzilla::3_6rc1::Result::flagtypes;
...
Related object: L<Schema::Bugzilla::3_6rc1::Result::groups>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:H8e9eIxUmkMiEJ5R6tmdPg
