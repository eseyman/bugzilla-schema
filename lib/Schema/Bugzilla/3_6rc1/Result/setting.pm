use utf8;
package Schema::Bugzilla::3_6rc1::Result::setting;
...
Related object: L<Schema::Bugzilla::3_6rc1::Result::setting_value>

=cut

__PACKAGE__->has_many(
  "setting_values",
  "Schema::Bugzilla::3_6rc1::Result::setting_value",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:p1ki6eZfV4IjMeP1pGxQMg
