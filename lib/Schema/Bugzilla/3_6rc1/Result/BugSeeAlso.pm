use utf8;
package Schema::Bugzilla::3_6rc1::Result::BugSeeAlso;
...
Schema::Bugzilla::3_6rc1::Result::BugSeeAlso
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:H0TKRuYfNekIWOzbHUFAFA
