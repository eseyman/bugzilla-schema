use utf8;
package Schema::Bugzilla::3_6rc1::Result::Keyworddef;
...
Schema::Bugzilla::3_6rc1::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5w4A2+VHwLBOUzJIKIE+4A
