use utf8;
package Schema::Bugzilla::3_6rc1::Result::bug_see_also;
...
Schema::Bugzilla::3_6rc1::Result::bug_see_also
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3HfhzE1nL1dxKsD0ABSGlg
