use utf8;
package Schema::Bugzilla::3_6rc1::Result::bugs_fulltext;
...
Schema::Bugzilla::3_6rc1::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:e8CMoXJiWA/jKIxRT9bYzA
