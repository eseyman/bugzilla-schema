use utf8;
package Schema::Bugzilla::3_6rc1::Result::ts_funcmap;
...
Schema::Bugzilla::3_6rc1::Result::ts_funcmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BABL6QQxjwNr8C8o1XvlrQ
