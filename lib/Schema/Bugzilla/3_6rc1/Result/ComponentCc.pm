use utf8;
package Schema::Bugzilla::3_6rc1::Result::ComponentCc;
...
Schema::Bugzilla::3_6rc1::Result::ComponentCc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nlc0ZLN5lW7MXAFE91gmjQ
