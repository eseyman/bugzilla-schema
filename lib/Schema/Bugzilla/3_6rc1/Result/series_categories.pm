use utf8;
package Schema::Bugzilla::3_6rc1::Result::series_categories;
...
Schema::Bugzilla::3_6rc1::Result::series_categories
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:huZezjc8FCdinerxMa8Vtg
