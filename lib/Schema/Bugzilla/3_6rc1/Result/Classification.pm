use utf8;
package Schema::Bugzilla::3_6rc1::Result::Classification;
...
Schema::Bugzilla::3_6rc1::Result::Classification
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KTZ9jCqu9/xmYtQGY7WRUg
