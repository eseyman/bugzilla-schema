use utf8;
package Schema::Bugzilla::3_6rc1::Result::SettingValue;
...
Schema::Bugzilla::3_6rc1::Result::SettingValue
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HWeh1+ROe3iQtUHOLPeFAA
