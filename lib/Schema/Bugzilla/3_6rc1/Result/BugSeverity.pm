use utf8;
package Schema::Bugzilla::3_6rc1::Result::BugSeverity;
...
Schema::Bugzilla::3_6rc1::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+FQNhYpXPfFhdhW1p/S2og
