use utf8;
package Schema::Bugzilla::3_6rc1::Result::StatusWorkflow;
...
Schema::Bugzilla::3_6rc1::Result::StatusWorkflow
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LW+UaguR5tscuc7MgU9iLg
