use utf8;
package Schema::Bugzilla::3_6rc1::Result::RepPlatform;
...
Schema::Bugzilla::3_6rc1::Result::RepPlatform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MCRspdgu/fb8EK0rpX8mUg
