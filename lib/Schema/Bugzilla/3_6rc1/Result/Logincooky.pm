use utf8;
package Schema::Bugzilla::3_6rc1::Result::Logincooky;
...
Schema::Bugzilla::3_6rc1::Result::Logincooky
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tZHtodfOZGXT2Exm0XeW8Q
