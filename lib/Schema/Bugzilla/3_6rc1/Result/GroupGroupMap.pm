use utf8;
package Schema::Bugzilla::3_6rc1::Result::GroupGroupMap;
...
Schema::Bugzilla::3_6rc1::Result::GroupGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yUVuW17AIDJlk0yNjln0fA
