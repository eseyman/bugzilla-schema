use utf8;
package Schema::Bugzilla::3_6rc1::Result::BzSchema;
...
Schema::Bugzilla::3_6rc1::Result::BzSchema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:a5IVy/Zo0+DFGzuZbZ5nfA
