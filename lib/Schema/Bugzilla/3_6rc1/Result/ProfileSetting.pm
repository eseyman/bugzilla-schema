use utf8;
package Schema::Bugzilla::3_6rc1::Result::ProfileSetting;
...
Schema::Bugzilla::3_6rc1::Result::ProfileSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xy0HH2OKHAViRRRtsywJhQ
