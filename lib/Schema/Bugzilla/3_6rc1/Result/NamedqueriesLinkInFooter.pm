use utf8;
package Schema::Bugzilla::3_6rc1::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::3_6rc1::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6zrh6MCEDA5oTCiB0iEAfQ
