use utf8;
package Schema::Bugzilla::3_6rc1::Result::Component;
...
Schema::Bugzilla::3_6rc1::Result::Component
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nVo6DCO3l9+QVClxwAhMag
