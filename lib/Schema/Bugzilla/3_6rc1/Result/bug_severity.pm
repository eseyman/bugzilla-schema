use utf8;
package Schema::Bugzilla::3_6rc1::Result::bug_severity;
...
Schema::Bugzilla::3_6rc1::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WAJudSEOejS1P7e+eQb/2Q
