use utf8;
package Schema::Bugzilla::3_3_2::Result::SeriesData;
...
Schema::Bugzilla::3_3_2::Result::SeriesData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:36rO3TzKFlSRNTYruZVVBw
