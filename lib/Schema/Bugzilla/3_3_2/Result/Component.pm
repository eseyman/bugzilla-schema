use utf8;
package Schema::Bugzilla::3_3_2::Result::Component;
...
Schema::Bugzilla::3_3_2::Result::Component
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pLB1uZTBlaTLe6P1M5xXvg
