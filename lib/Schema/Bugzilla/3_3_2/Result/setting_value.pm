use utf8;
package Schema::Bugzilla::3_3_2::Result::setting_value;
...
Schema::Bugzilla::3_3_2::Result::setting_value
...
Related object: L<Schema::Bugzilla::3_3_2::Result::setting>

=cut

__PACKAGE__->belongs_to(
  "name",
  "Schema::Bugzilla::3_3_2::Result::setting",
  { name => "name" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qRBenrgBowAkqzgqctZpjw
