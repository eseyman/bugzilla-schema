use utf8;
package Schema::Bugzilla::3_3_2::Result::bug_severity;
...
Schema::Bugzilla::3_3_2::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RX6vhLnaWxGVWFiSbFAQ+A
