use utf8;
package Schema::Bugzilla::3_3_2::Result::bug_status;
...
Schema::Bugzilla::3_3_2::Result::bug_status
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vhq+p9+ToaKdNxrEuYhOPQ
