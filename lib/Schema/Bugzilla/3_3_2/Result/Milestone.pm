use utf8;
package Schema::Bugzilla::3_3_2::Result::Milestone;
...
Schema::Bugzilla::3_3_2::Result::Milestone
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zcBk+ALZaRU+S1ec/Z3sNg
