use utf8;
package Schema::Bugzilla::3_3_2::Result::SettingValue;
...
Schema::Bugzilla::3_3_2::Result::SettingValue
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gEfilf1NR5oYrvVAKxBrfw
