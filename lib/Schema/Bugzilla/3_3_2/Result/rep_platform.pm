use utf8;
package Schema::Bugzilla::3_3_2::Result::rep_platform;
...
Schema::Bugzilla::3_3_2::Result::rep_platform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:b0i+m9weRyfZ+hehlmw55A
