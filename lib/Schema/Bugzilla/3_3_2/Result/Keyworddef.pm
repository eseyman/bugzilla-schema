use utf8;
package Schema::Bugzilla::3_3_2::Result::Keyworddef;
...
Schema::Bugzilla::3_3_2::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vXay6NVHg3wjs52SYa2AfA
