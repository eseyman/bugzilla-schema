use utf8;
package Schema::Bugzilla::3_3_2::Result::Logincooky;
...
Schema::Bugzilla::3_3_2::Result::Logincooky
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TBTXJJpAYmPhxZ9PoTvopQ
