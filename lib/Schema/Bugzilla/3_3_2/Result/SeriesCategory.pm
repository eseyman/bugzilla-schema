use utf8;
package Schema::Bugzilla::3_3_2::Result::SeriesCategory;
...
Schema::Bugzilla::3_3_2::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+E/Dunt6G2HbjZ+lQf+pfA
