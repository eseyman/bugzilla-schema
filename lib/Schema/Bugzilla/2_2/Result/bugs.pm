use utf8;
package Schema::Bugzilla::2_2::Result::bugs;
...
Schema::Bugzilla::2_2::Result::bugs
...
=head2 op_sys
  ...
  data_type: 'enum'
  extra: {list => ["All","Windows 3.1","Windows 95","Windows 98","Windows NT","Mac System 7","Mac System 7.5","Mac System 7.6.1","Mac System 8.0","Mac System 8.5","AIX","BSDI","HP-UX","IRIX","Linux","FreeBSD","OSF/1","Solaris","SunOS","OS/2","other"]}
  is_nullable: 0
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0MXxYzaxHh5jwtERjqSfcA
