use utf8;
package Schema::Bugzilla::2_2::Result::logincookies;
...
Schema::Bugzilla::2_2::Result::logincookies
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vQTOrjGVC+C/TPWEcW0fEg
