use utf8;
package Schema::Bugzilla::4_0rc2::Result::bug_status;
...
Related object: L<Schema::Bugzilla::4_0rc2::Result::status_workflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WJHiT+tSangKMjoShQZBfg
