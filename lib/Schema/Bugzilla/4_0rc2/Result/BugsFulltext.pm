use utf8;
package Schema::Bugzilla::4_0rc2::Result::BugsFulltext;
...
Schema::Bugzilla::4_0rc2::Result::BugsFulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4i8JBySqJSmvjKFihJ/t6g
