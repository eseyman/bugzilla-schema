use utf8;
package Schema::Bugzilla::4_0rc2::Result::rep_platform;
...
Schema::Bugzilla::4_0rc2::Result::rep_platform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jJeFErkomm5chss66qKlhQ
