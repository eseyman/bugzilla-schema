use utf8;
package Schema::Bugzilla::4_0rc2::Result::bug_severity;
...
Schema::Bugzilla::4_0rc2::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ClMBAWu+9xQ0cNT/ZN1SEg
