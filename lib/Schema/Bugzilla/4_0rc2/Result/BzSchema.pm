use utf8;
package Schema::Bugzilla::4_0rc2::Result::BzSchema;
...
Schema::Bugzilla::4_0rc2::Result::BzSchema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sK4jTf0jp4mbCoyQxwYrWQ
