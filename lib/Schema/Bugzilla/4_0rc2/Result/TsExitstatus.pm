use utf8;
package Schema::Bugzilla::4_0rc2::Result::TsExitstatus;
...
Schema::Bugzilla::4_0rc2::Result::TsExitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HwBAaOTttBblbNr9bSnHAA
