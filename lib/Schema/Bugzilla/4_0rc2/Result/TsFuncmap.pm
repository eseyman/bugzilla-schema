use utf8;
package Schema::Bugzilla::4_0rc2::Result::TsFuncmap;
...
Schema::Bugzilla::4_0rc2::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZnzmpndirX0/B/HBE6dzJw
