use utf8;
package Schema::Bugzilla::4_0rc1::Result::Flagtype;
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::Group>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dCSgnl6/VF4T7GUYU947Vw
