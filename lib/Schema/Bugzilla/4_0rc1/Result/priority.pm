use utf8;
package Schema::Bugzilla::4_0rc1::Result::priority;
...
Schema::Bugzilla::4_0rc1::Result::priority
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DC9Ef/7HbDLEk20bRz5s5w
