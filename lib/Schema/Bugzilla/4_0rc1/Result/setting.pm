use utf8;
package Schema::Bugzilla::4_0rc1::Result::setting;
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::setting_value>

=cut

__PACKAGE__->has_many(
  "setting_values",
  "Schema::Bugzilla::4_0rc1::Result::setting_value",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1xYOshHGkr2TiDmKsT7+Hw
