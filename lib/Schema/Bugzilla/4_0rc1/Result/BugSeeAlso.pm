use utf8;
package Schema::Bugzilla::4_0rc1::Result::BugSeeAlso;
...
Schema::Bugzilla::4_0rc1::Result::BugSeeAlso
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0zeAAw46exVBp2ZNrOLAoQ
