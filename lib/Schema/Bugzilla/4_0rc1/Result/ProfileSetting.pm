use utf8;
package Schema::Bugzilla::4_0rc1::Result::ProfileSetting;
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::Setting>

=cut

__PACKAGE__->belongs_to(
  "setting_name",
  "Schema::Bugzilla::4_0rc1::Result::Setting",
  { name => "setting_name" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iXo2D1nivmkyM5mRPSQ+oQ
