use utf8;
package Schema::Bugzilla::4_0rc1::Result::ts_funcmap;
...
Schema::Bugzilla::4_0rc1::Result::ts_funcmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+ebt5kmMR5cVZJx9CIM/NQ
