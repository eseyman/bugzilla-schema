use utf8;
package Schema::Bugzilla::4_0rc1::Result::BugStatus;
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::StatusWorkflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bzSXTMNVNMPPDVCbK43jdw
