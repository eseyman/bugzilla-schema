use utf8;
package Schema::Bugzilla::4_0rc1::Result::BugSeverity;
...
Schema::Bugzilla::4_0rc1::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XVfdLXhwVApvI9kbh+vkWA
