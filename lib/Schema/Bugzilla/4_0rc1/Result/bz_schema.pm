use utf8;
package Schema::Bugzilla::4_0rc1::Result::bz_schema;
...
Schema::Bugzilla::4_0rc1::Result::bz_schema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PZwnRpqZ9ARCxYEAt7sCaQ
