use utf8;
package Schema::Bugzilla::4_0rc1::Result::profiles_activity;
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::fielddefs>

=cut

__PACKAGE__->belongs_to(
  "fieldid",
  "Schema::Bugzilla::4_0rc1::Result::fielddefs",
  { id => "fieldid" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WkdeUrNnVTUWqaZbc4UwbA
