use utf8;
package Schema::Bugzilla::4_0rc1::Result::bugs;
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::dependencies>

=cut

__PACKAGE__->has_many(
  "dependencies_blocked",
  "Schema::Bugzilla::4_0rc1::Result::dependencies",
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::duplicates>

=cut

__PACKAGE__->might_have(
  "duplicates_dupe",
  "Schema::Bugzilla::4_0rc1::Result::duplicates",
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::keywords>

=cut

__PACKAGE__->has_many(
  "keywords",
  "Schema::Bugzilla::4_0rc1::Result::keywords",
  { "foreign.bug_id" => "self.bug_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::products>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ALaNoL4UsB2tZXufuWfodg
