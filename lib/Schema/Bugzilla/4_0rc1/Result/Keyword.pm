use utf8;
package Schema::Bugzilla::4_0rc1::Result::Keyword;
...
Related object: L<Schema::Bugzilla::4_0rc1::Result::Keyworddef>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:takkl9Py6xknsP+Ntj2+rQ
