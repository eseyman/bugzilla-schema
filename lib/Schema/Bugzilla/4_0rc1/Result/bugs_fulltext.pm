use utf8;
package Schema::Bugzilla::4_0rc1::Result::bugs_fulltext;
...
Schema::Bugzilla::4_0rc1::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:46Acn2+EpbD16cmpYGNFHQ
