use utf8;
package Schema::Bugzilla::4_0rc1::Result::bug_see_also;
...
Schema::Bugzilla::4_0rc1::Result::bug_see_also
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GHSPJsEtwYZooUos0fmAAg
