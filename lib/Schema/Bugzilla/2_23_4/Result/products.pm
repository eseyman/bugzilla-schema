use utf8;
package Schema::Bugzilla::2_23_4::Result::products;
...
Schema::Bugzilla::2_23_4::Result::products
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GNQt2DELJpxfkAKO1l1Xqw
