use utf8;
package Schema::Bugzilla::2_23_4::Result::Flagtype;
...
Schema::Bugzilla::2_23_4::Result::Flagtype
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:11WrB1OU5s/kTysl5+upTw
