use utf8;
package Schema::Bugzilla::2_23_4::Result::SettingValue;
...
Schema::Bugzilla::2_23_4::Result::SettingValue
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6+xtlcGvGpHiFyqgyOEfUQ
