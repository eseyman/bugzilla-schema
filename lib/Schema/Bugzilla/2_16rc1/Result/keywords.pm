use utf8;
package Schema::Bugzilla::2_16rc1::Result::keywords;
...
Schema::Bugzilla::2_16rc1::Result::keywords
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AsJ4UZ6ISVF+alNCqLrKGw
