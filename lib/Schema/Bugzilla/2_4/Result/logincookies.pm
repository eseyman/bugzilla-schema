use utf8;
package Schema::Bugzilla::2_4::Result::logincookies;
...
Schema::Bugzilla::2_4::Result::logincookies
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eV0OmshJvrglDJy6Zfjg/Q
