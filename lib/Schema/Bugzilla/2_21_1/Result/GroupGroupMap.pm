use utf8;
package Schema::Bugzilla::2_21_1::Result::GroupGroupMap;
...
Schema::Bugzilla::2_21_1::Result::GroupGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DeQhsvfx5dj2CIc8+0vhoQ
