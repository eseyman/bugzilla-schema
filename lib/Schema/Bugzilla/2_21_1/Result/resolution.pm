use utf8;
package Schema::Bugzilla::2_21_1::Result::resolution;
...
Schema::Bugzilla::2_21_1::Result::resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qdLzUnwMFvJ+jjyKqepGHw
