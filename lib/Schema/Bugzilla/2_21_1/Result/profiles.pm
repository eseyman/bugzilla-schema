use utf8;
package Schema::Bugzilla::2_21_1::Result::profiles;
...
Schema::Bugzilla::2_21_1::Result::profiles
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RUgyNbHSLxLs4ZHPHGH3BQ
