use utf8;
package Schema::Bugzilla::2_21_1::Result::SettingValue;
...
Schema::Bugzilla::2_21_1::Result::SettingValue
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sVNOXXGPmwjnDszVmWQZUQ
