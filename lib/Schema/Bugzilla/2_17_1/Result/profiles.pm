use utf8;
package Schema::Bugzilla::2_17_1::Result::profiles;
...
Schema::Bugzilla::2_17_1::Result::profiles
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:voyeRha0D1mH7V2QyAAnZg
