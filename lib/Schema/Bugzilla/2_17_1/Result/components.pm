use utf8;
package Schema::Bugzilla::2_17_1::Result::components;
...
Schema::Bugzilla::2_17_1::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yvzQaFku//Foa5ECoUpyFA
