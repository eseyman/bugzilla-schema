use utf8;
package Schema::Bugzilla::5_1_2::Result::SeriesCategory;
...
Schema::Bugzilla::5_1_2::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+MuHsYo1XIA5GtJ2UGW+sQ
