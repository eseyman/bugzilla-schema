use utf8;
package Schema::Bugzilla::5_1_2::Result::Flagtype;
...
Related object: L<Schema::Bugzilla::5_1_2::Result::Group>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Q/YLsPYkFZWq84PeIrfUMg
