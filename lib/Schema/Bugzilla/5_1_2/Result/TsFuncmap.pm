use utf8;
package Schema::Bugzilla::5_1_2::Result::TsFuncmap;
...
Schema::Bugzilla::5_1_2::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iLL/vtAxaq8hTGSfCrpdkw
