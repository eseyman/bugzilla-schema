use utf8;
package Schema::Bugzilla::5_1_2::Result::Longdesc;
...
Related object: L<Schema::Bugzilla::5_1_2::Result::LongdescsTag>

=cut

__PACKAGE__->has_many(
  "longdescs_tags",
  "Schema::Bugzilla::5_1_2::Result::LongdescsTag",
  { "foreign.comment_id" => "self.comment_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+zrAgEnFHwOciH3JpbMQ1Q
