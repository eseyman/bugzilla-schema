use utf8;
package Schema::Bugzilla::5_1_2::Result::BugSeverity;
...
Schema::Bugzilla::5_1_2::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Rijs6ZrCFYYLaTpnclfsaw
