use utf8;
package Schema::Bugzilla::4_3_1::Result::SeriesCategory;
...
Schema::Bugzilla::4_3_1::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zAoIjPjWKXryvZ5A1IFD5w
