use utf8;
package Schema::Bugzilla::4_3_1::Result::BugStatus;
...
Related object: L<Schema::Bugzilla::4_3_1::Result::StatusWorkflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BgZQgb46tru9/AwvcKIe0Q
