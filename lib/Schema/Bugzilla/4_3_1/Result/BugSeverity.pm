use utf8;
package Schema::Bugzilla::4_3_1::Result::BugSeverity;
...
Schema::Bugzilla::4_3_1::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6eXYtE+SZlyZedbYbxdrdg
