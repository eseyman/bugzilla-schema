use utf8;
package Schema::Bugzilla::4_3_1::Result::flagtypes;
...
Related object: L<Schema::Bugzilla::4_3_1::Result::groups>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:54ahVpCHhoglaH9orGP7UQ
