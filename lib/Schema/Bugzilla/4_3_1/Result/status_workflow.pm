use utf8;
package Schema::Bugzilla::4_3_1::Result::status_workflow;
...
Schema::Bugzilla::4_3_1::Result::status_workflow
...
Related object: L<Schema::Bugzilla::4_3_1::Result::bug_status>

=cut

__PACKAGE__->belongs_to(
  "new_status",
  "Schema::Bugzilla::4_3_1::Result::bug_status",
  { id => "new_status" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GxvuODUgLMu+UHSiay7lbA
