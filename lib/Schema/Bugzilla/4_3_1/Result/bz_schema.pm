use utf8;
package Schema::Bugzilla::4_3_1::Result::bz_schema;
...
Schema::Bugzilla::4_3_1::Result::bz_schema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4XF2SraStw0HhXliKpQE6w
