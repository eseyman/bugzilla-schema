...
Related object: L<Schema::Bugzilla::4_3_1::Result::SettingValue>

=cut

__PACKAGE__->has_many(
  "setting_values",
  "Schema::Bugzilla::4_3_1::Result::SettingValue",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:X0fOoSFyemUQcTRn5n+1sg
