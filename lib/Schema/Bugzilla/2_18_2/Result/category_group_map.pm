use utf8;
package Schema::Bugzilla::2_18_2::Result::category_group_map;
...
Schema::Bugzilla::2_18_2::Result::category_group_map
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FdloRYmE+xU8Qyla+/dhNA
