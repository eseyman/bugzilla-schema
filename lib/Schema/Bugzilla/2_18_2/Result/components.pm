use utf8;
package Schema::Bugzilla::2_18_2::Result::components;
...
Schema::Bugzilla::2_18_2::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HcyRJRnZmCQFDi7zhoOBCg
