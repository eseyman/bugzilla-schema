use utf8;
package Schema::Bugzilla::3_1_3::Result::bz_schema;
...
Schema::Bugzilla::3_1_3::Result::bz_schema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:h7pfVe5IbnirkMdBYsXT5Q
