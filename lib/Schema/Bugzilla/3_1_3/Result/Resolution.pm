use utf8;
package Schema::Bugzilla::3_1_3::Result::Resolution;
...
Schema::Bugzilla::3_1_3::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AyU/TX8CpP64CxGJjGsGQw
