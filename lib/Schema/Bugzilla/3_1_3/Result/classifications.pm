use utf8;
package Schema::Bugzilla::3_1_3::Result::classifications;
...
Schema::Bugzilla::3_1_3::Result::classifications
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:M8oTwaRRhSlk5piLScTb8g
