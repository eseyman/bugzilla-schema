use utf8;
package Schema::Bugzilla::3_1_3::Result::BugSeverity;
...
Schema::Bugzilla::3_1_3::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:czRrM+Ww+8xXMOd2vRTRrw
