use utf8;
package Schema::Bugzilla::3_1_3::Result::GroupGroupMap;
...
Schema::Bugzilla::3_1_3::Result::GroupGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:G+LIiy1JblCX/wMknVI8XQ
