use utf8;
package Schema::Bugzilla::3_1_3::Result::Attachment;
...
Schema::Bugzilla::3_1_3::Result::Attachment
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bMHQ9jeZBwJTejBMJDl7Ow
