use utf8;
package Schema::Bugzilla::3_1_3::Result::Classification;
...
Schema::Bugzilla::3_1_3::Result::Classification
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QH+dCCui9xhpHbsqNEdhaQ
