use utf8;
package Schema::Bugzilla::3_1_3::Result::SeriesData;
...
Schema::Bugzilla::3_1_3::Result::SeriesData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:op6ORbAnhfA9hT+X191skg
