use utf8;
package Schema::Bugzilla::3_1_3::Result::ProfileSetting;
...
Schema::Bugzilla::3_1_3::Result::ProfileSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kju4Hu2MpkdnyWcHXBmrHw
