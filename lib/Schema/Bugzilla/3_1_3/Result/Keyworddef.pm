use utf8;
package Schema::Bugzilla::3_1_3::Result::Keyworddef;
...
Schema::Bugzilla::3_1_3::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uPTUwUMlxAWtH1greIQCZA
