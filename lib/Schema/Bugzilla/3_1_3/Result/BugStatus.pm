use utf8;
package Schema::Bugzilla::3_1_3::Result::BugStatus;
...
Schema::Bugzilla::3_1_3::Result::BugStatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MUKM3LZhFUGhLPbNYtvU6g
