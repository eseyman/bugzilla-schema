use utf8;
package Schema::Bugzilla::3_1_3::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_1_3::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum://33lA14iogvPmoY+decDQ
