use utf8;
package Schema::Bugzilla::3_1_3::Result::Component;
...
Schema::Bugzilla::3_1_3::Result::Component
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zT0fUjvvp+3QKMtUCrzqZw
