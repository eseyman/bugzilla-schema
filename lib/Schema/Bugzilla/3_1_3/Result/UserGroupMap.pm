use utf8;
package Schema::Bugzilla::3_1_3::Result::UserGroupMap;
...
Schema::Bugzilla::3_1_3::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:z2XzIpl+6KF2FcDriQiHaA
