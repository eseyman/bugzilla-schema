use utf8;
package Schema::Bugzilla::3_1_3::Result::status_workflow;
...
Schema::Bugzilla::3_1_3::Result::status_workflow
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HMlGQzrRSNSMD8BsfX91Pg
