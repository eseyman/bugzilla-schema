use utf8;
package Schema::Bugzilla::2_18rc1::Result::components;
...
Schema::Bugzilla::2_18rc1::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2sUWCgxo7nI0FwdEDJ9wqw
