use utf8;
package Schema::Bugzilla::2_18rc1::Result::BugGroupMap;
...
Schema::Bugzilla::2_18rc1::Result::BugGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HbQIh2s/mP9yeiaU+0gQRQ
