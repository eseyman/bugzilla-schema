use utf8;
package Schema::Bugzilla::2_18rc1::Result::profiles;
...
Schema::Bugzilla::2_18rc1::Result::profiles
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hdb//RtJtOwvOcVrqEqSng
