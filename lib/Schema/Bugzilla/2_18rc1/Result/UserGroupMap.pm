use utf8;
package Schema::Bugzilla::2_18rc1::Result::UserGroupMap;
...
Schema::Bugzilla::2_18rc1::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nF5pke+mFLveFP2IIx3swA
