use utf8;
package Schema::Bugzilla::2_18rc1::Result::SeriesData;
...
Schema::Bugzilla::2_18rc1::Result::SeriesData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dzLZ+6YwHqjmZxFdFDnnAg
