use utf8;
package Schema::Bugzilla::3_7_2::Result::NamedqueryGroupMap;
...
Schema::Bugzilla::3_7_2::Result::NamedqueryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jIjnGCIVZSPEFF8s4B5Lqg
