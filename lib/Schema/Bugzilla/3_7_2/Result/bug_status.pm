use utf8;
package Schema::Bugzilla::3_7_2::Result::bug_status;
...
Related object: L<Schema::Bugzilla::3_7_2::Result::status_workflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:X7O8+BqXoHDUPqjJFV4PwQ
