use utf8;
package Schema::Bugzilla::3_7_2::Result::UserGroupMap;
...
Schema::Bugzilla::3_7_2::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:T5UbM3SRm3MhU+3ZLwUgmw
