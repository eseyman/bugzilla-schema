use utf8;
package Schema::Bugzilla::3_7_2::Result::bug_severity;
...
Schema::Bugzilla::3_7_2::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:36Lo5CHDqxuUN6qbHwt3qg
