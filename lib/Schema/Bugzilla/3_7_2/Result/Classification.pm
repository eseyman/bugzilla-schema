use utf8;
package Schema::Bugzilla::3_7_2::Result::Classification;
...
Schema::Bugzilla::3_7_2::Result::Classification
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HdEnVeypCq6JukSabyAuSA
