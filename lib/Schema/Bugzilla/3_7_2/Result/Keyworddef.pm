use utf8;
package Schema::Bugzilla::3_7_2::Result::Keyworddef;
...
Schema::Bugzilla::3_7_2::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vqgwvZWC4Pa2ftocUhqYtQ
