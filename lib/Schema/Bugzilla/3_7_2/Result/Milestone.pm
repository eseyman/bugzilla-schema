use utf8;
package Schema::Bugzilla::3_7_2::Result::Milestone;
...
Schema::Bugzilla::3_7_2::Result::Milestone
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zIEfLryR+ixvLDuAmHv6/w
