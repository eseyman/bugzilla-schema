use utf8;
package Schema::Bugzilla::3_7_2::Result::Attachment;
...
Schema::Bugzilla::3_7_2::Result::Attachment
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:F/2ONNVjA5PQkE+Rj++yrw
