use utf8;
package Schema::Bugzilla::3_7_2::Result::StatusWorkflow;
...
Schema::Bugzilla::3_7_2::Result::StatusWorkflow
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:c3qECOeOBEusV+LfEPqkMQ
