use utf8;
package Schema::Bugzilla::3_7_2::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::3_7_2::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/4Reu+n+rgN3fS+zpE7jKA
