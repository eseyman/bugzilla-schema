use utf8;
package Schema::Bugzilla::3_7_2::Result::SeriesData;
...
Schema::Bugzilla::3_7_2::Result::SeriesData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EzbPY/7qgMag/Rq2OmReXQ
