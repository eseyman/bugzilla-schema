use utf8;
package Schema::Bugzilla::3_7_2::Result::Namedquery;
...
Schema::Bugzilla::3_7_2::Result::Namedquery
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WbtvB2yiUu7QjgjYuna7kg
