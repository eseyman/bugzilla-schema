use utf8;
package Schema::Bugzilla::3_7_2::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_7_2::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Y+ihHvSQl3duljwB93lbRQ
