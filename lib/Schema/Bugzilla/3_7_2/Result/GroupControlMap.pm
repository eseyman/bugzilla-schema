use utf8;
package Schema::Bugzilla::3_7_2::Result::GroupControlMap;
...
Schema::Bugzilla::3_7_2::Result::GroupControlMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OfxuSMGxp9UmMEbWCHzxeA
