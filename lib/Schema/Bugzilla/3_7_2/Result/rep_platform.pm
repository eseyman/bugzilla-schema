use utf8;
package Schema::Bugzilla::3_7_2::Result::rep_platform;
...
Schema::Bugzilla::3_7_2::Result::rep_platform
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RVRG4xOy2DttAob/F/R1zw
