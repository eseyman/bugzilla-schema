use utf8;
package Schema::Bugzilla::2_17_4::Result::components;
...
Schema::Bugzilla::2_17_4::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DdCBinE/W59BSTolFdErmg
