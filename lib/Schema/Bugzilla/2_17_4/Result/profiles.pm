use utf8;
package Schema::Bugzilla::2_17_4::Result::profiles;
...
Schema::Bugzilla::2_17_4::Result::profiles
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QTN8r6lTs6+pFxZbuVdTAA
