use utf8;
package Schema::Bugzilla::2_19_2::Result::milestones;
...
Schema::Bugzilla::2_19_2::Result::milestones
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+sfEgRNcSSNF+/wqkdt2OQ
