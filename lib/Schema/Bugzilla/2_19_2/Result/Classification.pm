use utf8;
package Schema::Bugzilla::2_19_2::Result::Classification;
...
Schema::Bugzilla::2_19_2::Result::Classification
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rdZhdanRjoq6+vjB84VyDA
