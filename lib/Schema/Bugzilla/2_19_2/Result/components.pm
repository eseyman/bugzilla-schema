use utf8;
package Schema::Bugzilla::2_19_2::Result::components;
...
Schema::Bugzilla::2_19_2::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kdC2m4Guqnu4V4qmXKmawg
