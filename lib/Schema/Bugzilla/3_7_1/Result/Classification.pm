use utf8;
package Schema::Bugzilla::3_7_1::Result::Classification;
...
Schema::Bugzilla::3_7_1::Result::Classification
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nlxrlMXfR5vpbx5t2giWQg
