use utf8;
package Schema::Bugzilla::3_7_1::Result::ts_exitstatus;
...
Schema::Bugzilla::3_7_1::Result::ts_exitstatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:f9xpJm5o9fHjMJQUlitlrQ
