use utf8;
package Schema::Bugzilla::3_7_1::Result::EmailSetting;
...
Schema::Bugzilla::3_7_1::Result::EmailSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:q1mSbLSQi5SdsNn+FWl1ew
