use utf8;
package Schema::Bugzilla::3_7_1::Result::Logincooky;
...
Schema::Bugzilla::3_7_1::Result::Logincooky
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dqNQrLdAYfMtcU4LPdG+ow
