use utf8;
package Schema::Bugzilla::3_7_1::Result::Namedquery;
...
Schema::Bugzilla::3_7_1::Result::Namedquery
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oVTH0I+6xTpdcJJcgtxrgw
