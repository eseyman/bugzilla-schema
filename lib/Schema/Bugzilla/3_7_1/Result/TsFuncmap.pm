use utf8;
package Schema::Bugzilla::3_7_1::Result::TsFuncmap;
...
Schema::Bugzilla::3_7_1::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ieJX+EZfjY9ZEtjYdpI1oQ
