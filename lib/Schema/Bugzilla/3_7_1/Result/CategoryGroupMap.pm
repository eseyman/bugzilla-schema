use utf8;
package Schema::Bugzilla::3_7_1::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_7_1::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IO+GH8CtPKGfvCRWcd6+4w
