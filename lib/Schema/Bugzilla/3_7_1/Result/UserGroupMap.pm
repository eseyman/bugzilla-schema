use utf8;
package Schema::Bugzilla::3_7_1::Result::UserGroupMap;
...
Schema::Bugzilla::3_7_1::Result::UserGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:I5r9IQsyH+bHywN7iLHPPQ
