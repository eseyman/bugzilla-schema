use utf8;
package Schema::Bugzilla::3_7_1::Result::status_workflow;
...
Related object: L<Schema::Bugzilla::3_7_1::Result::bug_status>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:obfZvJKjVX53yyFk80/onA
