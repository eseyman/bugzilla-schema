use utf8;
package Schema::Bugzilla::3_7_1::Result::bz_schema;
...
Schema::Bugzilla::3_7_1::Result::bz_schema
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GdGFHRc2HiK1s79Qx6+nSA
