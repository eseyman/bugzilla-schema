use utf8;
package Schema::Bugzilla::3_7_1::Result::SeriesData;
...
Schema::Bugzilla::3_7_1::Result::SeriesData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Cibdx7NR/T8vpGHdVxzHQQ
