use utf8;
package Schema::Bugzilla::3_7_1::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::3_7_1::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zbRu63NJdBkKSdds4PbMxw
