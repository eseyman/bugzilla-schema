use utf8;
package Schema::Bugzilla::3_7_1::Result::keyworddefs;
...
Schema::Bugzilla::3_7_1::Result::keyworddefs
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yyMNx2dLxWHfiVyVNAgMtw
