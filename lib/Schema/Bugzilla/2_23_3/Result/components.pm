use utf8;
package Schema::Bugzilla::2_23_3::Result::components;
...
Schema::Bugzilla::2_23_3::Result::components
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KRggHm4bODO4cN65JRPYrA
