use utf8;
package Schema::Bugzilla::2_23_3::Result::versions;
...
Schema::Bugzilla::2_23_3::Result::versions
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VOU0dIRamfxEDNUJhX0bpg
