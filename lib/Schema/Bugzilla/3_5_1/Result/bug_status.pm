use utf8;
package Schema::Bugzilla::3_5_1::Result::bug_status;
...
Related object: L<Schema::Bugzilla::3_5_1::Result::status_workflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DkA04CQrKNZHvAy0FXuEmw
