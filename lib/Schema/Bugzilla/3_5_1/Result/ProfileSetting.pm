use utf8;
package Schema::Bugzilla::3_5_1::Result::ProfileSetting;
...
Schema::Bugzilla::3_5_1::Result::ProfileSetting
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nyR/T2dzYYp1e/llABCIhA
