use utf8;
package Schema::Bugzilla::3_5_1::Result::Keyworddef;
...
Schema::Bugzilla::3_5_1::Result::Keyworddef
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LbxMbG0xdwrVqX3yYkGFaQ
