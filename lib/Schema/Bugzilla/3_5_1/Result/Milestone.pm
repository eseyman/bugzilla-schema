use utf8;
package Schema::Bugzilla::3_5_1::Result::Milestone;
...
Schema::Bugzilla::3_5_1::Result::Milestone
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vGDYNzI64Vg2LtaYnB8RVQ
