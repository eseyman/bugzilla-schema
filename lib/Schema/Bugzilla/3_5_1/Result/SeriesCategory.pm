use utf8;
package Schema::Bugzilla::3_5_1::Result::SeriesCategory;
...
Schema::Bugzilla::3_5_1::Result::SeriesCategory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5nto+yYwt2B5ea9wX0QYcg
