use utf8;
package Schema::Bugzilla::3_5_1::Result::BugSeverity;
...
Schema::Bugzilla::3_5_1::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:w0qWOa3ec7Imp6ozUEomZg
