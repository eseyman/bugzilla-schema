use utf8;
package Schema::Bugzilla::3_5_1::Result::bug_severity;
...
Schema::Bugzilla::3_5_1::Result::bug_severity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XPnEcNeaM3SW8KIeGdDFNQ
