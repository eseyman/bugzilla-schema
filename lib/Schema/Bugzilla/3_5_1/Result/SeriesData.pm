use utf8;
package Schema::Bugzilla::3_5_1::Result::SeriesData;
...
Schema::Bugzilla::3_5_1::Result::SeriesData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:N5Eh+QiAvbeRtUdviN4gSg
