use utf8;
package Schema::Bugzilla::3_5_1::Result::BugGroupMap;
...
Schema::Bugzilla::3_5_1::Result::BugGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ReE/1JJBJpluivab3Glhyg
