use utf8;
package Schema::Bugzilla::3_5_1::Result::NamedqueriesLinkInFooter;
...
Schema::Bugzilla::3_5_1::Result::NamedqueriesLinkInFooter
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OQm01Q4CFI2coMBZGE/Abw
