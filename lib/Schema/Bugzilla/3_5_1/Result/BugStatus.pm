use utf8;
package Schema::Bugzilla::3_5_1::Result::BugStatus;
...
Schema::Bugzilla::3_5_1::Result::BugStatus
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:D+T3D1AFKRasjIEcAt7QxQ
