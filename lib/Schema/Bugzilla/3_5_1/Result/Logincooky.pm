use utf8;
package Schema::Bugzilla::3_5_1::Result::Logincooky;
...
Schema::Bugzilla::3_5_1::Result::Logincooky
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+mKgxmk3pD2zFLE8XApnzQ
