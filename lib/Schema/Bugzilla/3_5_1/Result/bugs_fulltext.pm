use utf8;
package Schema::Bugzilla::3_5_1::Result::bugs_fulltext;
...
Schema::Bugzilla::3_5_1::Result::bugs_fulltext
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:89xK6tESsr7LbLv4KvWtYQ
