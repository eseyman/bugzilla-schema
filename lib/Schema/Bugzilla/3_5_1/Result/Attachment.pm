use utf8;
package Schema::Bugzilla::3_5_1::Result::Attachment;
...
Schema::Bugzilla::3_5_1::Result::Attachment
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MYLqWOyqfDaQEvJk+oexUg
