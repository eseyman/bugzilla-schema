use utf8;
package Schema::Bugzilla::3_5_1::Result::CategoryGroupMap;
...
Schema::Bugzilla::3_5_1::Result::CategoryGroupMap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NluXzO3ryWlfF8abgOH8kw
