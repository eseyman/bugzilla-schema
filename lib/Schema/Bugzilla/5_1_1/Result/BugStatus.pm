use utf8;
package Schema::Bugzilla::5_1_1::Result::BugStatus;
...
Related object: L<Schema::Bugzilla::5_1_1::Result::StatusWorkflow>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ntj25CaGbs0yI+kuDzNAdQ
