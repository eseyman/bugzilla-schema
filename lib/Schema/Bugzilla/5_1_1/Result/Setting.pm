use utf8;
package Schema::Bugzilla::5_1_1::Result::Setting;
...
Related object: L<Schema::Bugzilla::5_1_1::Result::SettingValue>

=cut

__PACKAGE__->has_many(
  "setting_values",
  "Schema::Bugzilla::5_1_1::Result::SettingValue",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:r5xWSIpwOlobRObfTMrKMA
