use utf8;
package Schema::Bugzilla::5_1_1::Result::Resolution;
...
Schema::Bugzilla::5_1_1::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:laPLmdJq5WDqBflJB1DhaQ
