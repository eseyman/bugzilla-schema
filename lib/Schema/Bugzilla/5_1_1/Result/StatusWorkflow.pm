use utf8;
package Schema::Bugzilla::5_1_1::Result::StatusWorkflow;
...
Schema::Bugzilla::5_1_1::Result::StatusWorkflow
...
Related object: L<Schema::Bugzilla::5_1_1::Result::BugStatus>

=cut

__PACKAGE__->belongs_to(
  "new_status",
  "Schema::Bugzilla::5_1_1::Result::BugStatus",
  { id => "new_status" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YfrmOBT7tL2hV4y9LCvHTg
