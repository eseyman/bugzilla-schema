use utf8;
package Schema::Bugzilla::5_0_6::Result::BugSeverity;
...
Schema::Bugzilla::5_0_6::Result::BugSeverity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kR9zskEDPT0UUZOAwt/GpQ
