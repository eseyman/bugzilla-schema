use utf8;
package Schema::Bugzilla::5_0_6::Result::ProfileSetting;
...
Related object: L<Schema::Bugzilla::5_0_6::Result::Setting>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:O/zYIvOmHe8WrikEAK9nLw
