use utf8;
package Schema::Bugzilla::5_0_6::Result::TsFuncmap;
...
Schema::Bugzilla::5_0_6::Result::TsFuncmap
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ep+BgkSCDt5X87Q6nUvtxg
