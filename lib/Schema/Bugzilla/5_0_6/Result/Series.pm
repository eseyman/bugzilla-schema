use utf8;
package Schema::Bugzilla::5_0_6::Result::Series;
...
Related object: L<Schema::Bugzilla::5_0_6::Result::SeriesCategory>

=cut

__PACKAGE__->belongs_to(
  "category",
  "Schema::Bugzilla::5_0_6::Result::SeriesCategory",
  { id => "category" },
...
Related object: L<Schema::Bugzilla::5_0_6::Result::SeriesData>

=cut

__PACKAGE__->has_many(
  "series_datas",
  "Schema::Bugzilla::5_0_6::Result::SeriesData",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:P53RCYecR4Jrk3u8MDArOg
