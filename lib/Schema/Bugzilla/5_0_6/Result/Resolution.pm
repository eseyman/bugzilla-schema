use utf8;
package Schema::Bugzilla::5_0_6::Result::Resolution;
...
Schema::Bugzilla::5_0_6::Result::Resolution
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:goUJVVTU9Od8EsnoCDqFBA
